...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(11,'Según cuenta una leyenda polaca, hace muchos siglos, en las tierras gobernadas por el príncipe Krakus, empezaron a suceder hechos muy extraños que nadie lograba comprender. '+char(13)+'
	...
	(11,'Los habitantes de la zona estaban desconcertados ¿Cómo era posible que personas y animales desaparecieran como si se los hubiese tragado la tierra? Algo iba mal, pero nadie tenía ni idea de cómo solucionar el misterio. '+char(13)+'
	...
	(11,'Temblando como un flan salió pitando de allí y bajó al pueblo más cercano para avisar a todo el mundo. Después, fue al castillo para comunicárselo también al príncipe Krakus, quien consciente de la terrible amenaza  que suponía el reptil alado, mandó a los soldados más valerosos de su ejército a luchar contra él. '+char(13)+'
		Un grupo enorme, armado hasta los dientes,  tomó rumbo a la colina con una única misión: ¡abatir al temible enemigo!  Pero el dragón, que ya estaba despierto, vio que el ejército se acercaba  e intuyó que iban a por él. '+char(13)+'
	...
	(11,'Evidentemente, la operación resultó un fracaso. El dragón era demasiado fiero, demasiado fuerte y demasiado peligroso como para acercarse. '+char(13)+'
		El príncipe Krakus, como último recurso, promulgó un bando real: quien consiguiera vencer al monstruo, se casaría con lo que él más quería: su dulce hija Wanda. '+char(13)+'
	...
	(11,'¿Quieres saber qué hizo?… Consiguió la piel de un borrego, la rellenó con azufre y alquitrán, y por la noche, cuando el dragón dormía, la colocó en la entrada de la caverna. En cuanto se despertó de su profundo sueño, el animal vio la falsa oveja, se relamió y la devoró con ansia. '+char(13)+'
	...
	(11,'El zapatero fue aclamado como un auténtico héroe y recibió todos los honores posibles, aunque el mejor de todos los premios, fue casarse con la hermosa princesa Wanda. Dicen que fueron muy, muy  felices, durante toda la vida. '+char(13)+'
		Hoy en día, en Polonia,  existe una población en torno a la colina donde vivió, hace tantos siglos, el peligroso dragón. Está considerada una de las ciudades más importantes y bellas del país y se llama Cracovia, en honor a uno de los protagonistas de esta historia: el príncipe Krakus. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(12,'Érase una vez una preciosa muchacha llamada Untombina, hija del rey de una tribu africana. A unos kilómetros de su hogar había un lago muy famoso en toda la comarca porque en él se escondía un terrible monstruo que, según se contaba, devoraba a todo aquel que merodeaba por allí. '+char(13)+'
	...
	(12,'Cuando la primera de las muchachas salió del agua para vestirse, no encontró su ropa y avisó a todas las demás de lo que había sucedido.  Asustadísimas comenzaron a gritar y a preguntarse qué podían hacer ¡No podían volver desnudas al pueblo! '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(13,'Era la noche de Halloween y Margaret y su hijo Dani habían invitado a un viejo amigo a acompañarles y, tal vez, ver algunas pelis de miedo antes de dormir, pero el timbre parecía sonar demasiado temprano… '+char(13)+'
		∙	¡Hola Mark! Aún no está lista la cena, pero podéis pasar- Dijo Margaret a su amigo e invitado. '+char(13)+'
		Se trataba de Mark, el amigo de la familia que había sido invitado a la cena, pero que misteriosamente había llegado acompañado de una persona que no conocían. '+char(13)+'
		∙	Margaret, disculpa que haya traído a alguien sin avisar, pero no he tenido tiempo. Os presento a mi amigo Tom.'),
	(13,'En ese instante el hijo de Margaret, Dani, que bajaba las escaleras para unirse a la cena, gritó: '+char(13)+'
		∙	¡Ohh! ¡El aspecto es increíble! ¿Quién es? ¡Parece un vampiro real! '+char(13)+'
		∙	¿Te gustan los vampiros? –Preguntó Tom a Dani. '+char(13)+'
		∙	¡Me encantan! –Respondió Dani emocionado- ¿Quieres subir a ver mi colección de fotos y juegos de vampiros? '+char(13)+'
		Tom se giró para ver la reacción de Margaret y de Mark y, ante sus sonrisas, subió sin dudarlo más tiempo.'),
	(13,'Tom subió al piso superior, donde se encontraba la habitación de Dani, y entró en su cuarto. Dani se encontraba muy emocionado con la sorpresa de Mark, ya que no tenía muchos amigos y además le apasionaban los vampiros y todas las cosas de misterio. Necesitaba hablarle a alguien de todas sus aficiones y aquel muchacho, Tom, parecía ser la persona ideal. '+char(13)+'
		∙	¿Con que te gusta mi aspecto, eh? -Dijo Tom- Quizá yo pueda ayudarte a vestir como yo si quieres. '+char(13)+'
		∙	¿En serio? –Respondió Dani sorprendido- ¡Sería fantástico! '+char(13)+'
	...
	(13,'Dani, emocionado con su nuevo amigo y con la idea de poder al fin compartir aficiones, fue corriendo a quitarla sin preguntarse nada más. Y tras ello se pusieron manos a la obra y fueron buscando las mejores cosas con las que dar con un disfraz de vampiro para Dani. '+char(13)+'
		Ambos tardaron un buen rato en dar con lo que más se adecuaba a la ocasión, y finalmente bajaron a cenar. Dani bajó vestido de negro, con unas botas altas y una capa improvisada hecha con su sábana de dormir. ¡Ah! Y por supuesto unos colmillos que tenía guardados de anteriores disfraces. '+char(13)+'
		∙	Ahora sí me veo como un vampiro, ¡me veo como tú! ¿También tienes colmillos? '+char(13)+'
		∙	¡Sí, claro! ¡Todos los vampiros tenemos! '),
	(13,'Dani no podía creer que aquel chico tuviera los mismos gustos y el mismo sentido del humor que él. Durante la cena, Dani preparó unas copas y echó zumo de granada que había preparado su madre para dar más ambiente a la cena de Halloween, y así, riendo y brindando pasaron la noche los dos nuevos amigos. Entonces, de nuevo en la habitación, Tom propuso algo importante: '+char(13)+'
		∙	¿Quieres hacer lo que los vampiros hacemos? '+char(13)+'
		∙	¿Y qué es? –Respondió Dani. '+char(13)+'
		∙	Pues convertirnos en murciélagos. '+char(13)+'
		∙	¿En serio? –Respondió Dani maravillado. '+char(13)+'
		∙	¡Claro! –dijo Tom. '),
	(13,'Y tras aquellas palabras el cuerpo de Tom se transformó y se convirtió en un murciélago para volver a su forma humana casi de manera inmediata, tanto, que casi parecía imposible de ver bien. '+char(13)+'
		∙	¿Has visto? ¿Estás preparado tú? –Dijo Tom a Dani. '+char(13)+'
		∙	¡Sí! '+char(13)+'
		En ese instante ambos se transformaron en murciélagos y dieron muchas vueltas a través de la habitación. Después Tom propuso a Dani volar fuera de casa a través de los árboles y el cielo estrellado e iluminado. Y tras volar durante muchísimo rato regresaron a la habitación de Dani. '+char(13)+'
		∙	Yo tengo que irme ya –dijo Tom. '+char(13)+'
		∙	Pero, ¿por qué no vuelves a tu forma normal? – Preguntó Dani extrañado. '+char(13)+'
		∙	Porque así es más fácil volar e ir a otros lugares –dijo Tom-, pero ahora sabes cómo ser un verdadero vampiro cuando te apetezca. '+char(13)+''),
	(13,'Al cabo de un rato Dani escuchó la puerta y, al asomarse por la ventana, pudo ver como se despedían de su madre Mark y su amigo, alejándose tras ello poco a poco a paso tranquilo. Ya no era un murciélago…pero, ¿se trataba de un verdadero vampiro? La emoción no dejaba a Dani pensar con claridad y solo tenía clara una cosa… '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(14,'En una cabaña cerca del bosque vivía un leñador con sus dos hijos, que se llamaban Hansel y Gretel. El hombre se había casado por segunda vez con una mujer que no quería a los niños. Siempre se quejaba de que comían demasiado y que, por su culpa, el dinero no les llegaba para nada. '+char(13)+'
		– Ya no nos quedan monedas para comprar ni leche ni carne – dijo un día la madrastra – A este paso, moriremos todos de hambre. '+char(13)+'
		– Mujer… Los niños están creciendo y lo poco que tenemos es para comprar comida para ellos – contestó compungido el padre.'),
	(14,'– ¡No! ¡Hay otra solución! Tus hijos son lo bastante espabilados como para buscarse la vida ellos solos, así que mañana iremos al bosque y les abandonaremos allí. Seguro que con su ingenio conseguirán sobrevivir sin problemas y encontrarán un nuevo lugar para vivir – ordenó la madrastra envuelta en ira. '+char(13)+'
		– ¿Cómo voy a abandonar a mis hijos a su suerte? ¡Son sólo unos niños! '+char(13)+'
	...
	(14,'El buen hombre, a pesar de la angustia que sentía en el pecho, aceptó pensando que quizá su mujer tuviera razón y que dejarles libres sería lo mejor. '+char(13)+'
		Mientras el matrimonio hablaba sobre este tema, Hansel estaba en la habitación contigua escuchándolo todo. Horrorizado, se lo contó al oído a su hermana Gretel. La pobre niña comenzó a llorar amargamente. '+char(13)+'
		– ¿Qué haremos, hermano, tú y yo solitos en el bosque? Moriremos de hambre y frío. '+char(13)+'
		– No te preocupes, Gretel, confía en mí ¡Ya se me ocurrirá algo! – dijo Hansel con ternura, dándole un beso en la mejilla.'),
	(14,'Al día siguiente, antes del amanecer, la madrastra les despertó dando voces. '+char(13)+'
		– ¡Levantaos! ¡Es hora de ir a trabajar, holgazanes! '+char(13)+'
		Asustados y sin decir nada, los niños se vistieron y se dispusieron a acompañar a sus padres al bosque para recoger leña. La madrastra les esperaba en la puerta con un panecillo para cada uno. '+char(13)+'
		– Aquí tenéis un mendrugo de pan. No os lo comáis ahora, reservadlo para la hora del almuerzo, que queda mucho día por delante. '+char(13)+'
		Los cuatro iniciaron un largo recorrido por el sendero que se adentraba en el bosque. Era un día de otoño desapacible y frío. Miles de hojas secas de color tostado crujían bajo sus pies. '+char(13)+'
	...
	(14,'Al llegar a su destino, ayudaron en la dura tarea de recoger troncos y ramas. Tanto trabajaron que el sueño les venció y se quedaron dormidos al calor de una fogata. Cuando se despertaron, sus padres ya no estaban. '+char(13)+'
		– ¡Hansel, Hansel! – sollozó Gretel – ¡Se han ido y nos han dejado solos! ¿Cómo vamos a salir de aquí? El bosque está oscuro y es muy peligroso. '+char(13)+'
		– Tranquila hermanita, he dejado un rastro de migas de pan para poder regresar – dijo Hansel confiado. '+char(13)+'
		Pero por más que buscó las miguitas de pan, no encontró ni una ¡Los pájaros se las habían comido!'),
	(14,'Desesperados, comenzaron a vagar entre los árboles durante horas. Tiritaban de frío y tenían tanta hambre que casi no les quedaban fuerzas para seguir avanzando. Cuando ya lo daban todo por perdido, en un claro del bosque vieron una hermosa casita de chocolate. El tejado estaba decorado con caramelos de colores y las puertas y ventanas eran de bizcocho. Tenía un jardín pequeño cubierto de flores de azúcar y de la fuente brotaba sirope de fresa. '+char(13)+'
		Maravillados, los chiquillos se acercaron y comenzaron a comer todo lo que se les puso por delante ¡Qué rico estaba todo! '+char(13)+'
		Al rato, salió de la casa una mujer vieja y arrugada que les recibió con amabilidad. '+char(13)+'
	...
	(14,'Los niños, felices y confiados, entraron  en la casa sin sospechar que se trataba de una malvada bruja que había construido una casa de chocolate y caramelos para atraer a los niños y después comérselos. Una vez dentro, cerró la puerta con llave, cogió a Hansel y lo encerró en una celda de la que era imposible salir. Gretel, asustadísima,  comenzó a llorar. '+char(13)+'
		– ¡Tú, niñata, deja de lloriquear! A partir de ahora serás mi criada y te encargarás de cocinar para tu hermano. Quiero que engorde mucho y dentro de unas semanas me lo comeré. Como no obedezcas, tú correrás la misma suerte. '+char(13)+'
	...
	(14,'– Saca la mano por la reja – le decía para ver si su brazo estaba más gordito. '+char(13)+'
		El avispado Hansel  sacaba un hueso de pollo en vez de su brazo a través de los barrotes.  La bruja, que era corta de vista y con la oscuridad no distinguía nada, tocaba el hueso y se quejaba de que seguía siendo un niño flaco y sin carnes.  Durante semanas consiguió engañarla, pero un día la vieja se hartó. '+char(13)+'
		– ¡Tu hermano no engorda y ya me he cansado de esperar! – le dijo a Gretel – Prepara el horno, que hoy me lo voy a comer. '+char(13)+'
	...
	(14,'– ¡Serás inútil! – se quejó la malvada mujer mientras se agachaba frente al horno – ¡Tendré que hacerlo yo! '+char(13)+'
		La vieja metió la antorcha dentro del horno y cuando comenzó a crepitar el fuego, Gretel se armó de valor y de una patada la empujó dentro y cerró la puerta. Los gritos de espanto no conmovieron a la chiquilla; cogió las llaves de la celda y liberó a su hermano. '+char(13)+'
		Fuera de peligro, los dos recorrieron la casa y encontraron un cajón donde había valiosas joyas y piedras preciosas. Se llenaron los bolsillos y huyeron de allí. Se adentraron en el bosque de nuevo y la suerte quiso que encontraran fácilmente el camino que llevaba a su casa, guiándose por el brillante sol que lucía esa mañana. '+char(13)+''),
...
INSERT INTO [Page](IdContent,Text) 
	...
	(15,'Sin embargo, y a pesar de ser un niño tan precavido, hubo un día muy especial en el que Pablo sí que fue el niño más valiente del mundo. Todo ocurrió en las vacaciones de verano, cuando papá y mamá llevaron a Pablo y a sus amigos al parque de atracciones, donde subieron a toda clase de sitios emocionantes. Pero al caer el día y llegar la noche, todos juntos tuvieron una idea que asustó mucho al Pablo: '+char(13)+'
		•	Vamos a la casa del terror –Propuso Antonio, el más valiente de todos los niños. '+char(13)+'
		•	He escuchado que los verdaderos fantasmas viven en esos sitios–Comentó José, un poco asustado. '+char(13)+'
		•	Pues yo he escuchado que aprovechan la oscuridad y se llevan a los niños –dijo Pablo aterrado, – yo no quiero que me lleven, así que mejor vamos a otro sitio. '+char(13)+'
		•	Bah, esas cosas no son de verdad, Pablo –concluyó Antonio–, así que vamos, y lo haremos todos juntos. '+char(13)+''),
	(15,'A pesar de las insistencias de Pablo, en un par de minutos llegaron todos juntos hasta la entrada de la casa del terror. Mamá y papá esperaban a todos en la salida, por lo que no iba a poder darles siquiera la mano. Pablo sintió entonces que se moría de miedo, pero tras respirar profundamente se dejó llevar y entró en la casa del terror siguiendo al resto de sus amigos, que parecían realmente emocionados por estar allí y por descubrir los misterios que pudiera haber tras aquellas paredes. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(16,'Esta pequeña y sencilla historia cuenta lo que sucedió a un cordero que por envidia traspasó los límites del respeto y ofendió a sus compañeros. ¿Quieres conocerla?  '+char(13)+'
	...
	(16,'Curiosamente, a pesar de tener más derechos que ninguno, este cordero favorecido y sobrealimentado era un animal extremadamente egoísta: en cuanto veía que los granjeros rellenaban de pienso el comedero común, echaba a correr pisoteando a los demás para llegar el primero y engullir la máxima cantidad posible. Obviamente, el resto del rebaño se quedaba estupefacto pensando que no había ser más canalla que él en todo el planeta. '+char(13)+'
		Un día la oveja jefa, la que más mandaba, le dijo en tono muy enfadado: '+char(13)+'
		– ¡Pero qué cara más dura tienes! No entiendo cómo eres capaz de quitarle la comida a tus amigos. ¡Tú, que vives entre algodones y lo tienes todo!… ¡Eres un sinvergüenza! '+char(13)+'
		– Bueno, bueno, te estás pasando un poco… ¡Eso que dices no es justo!'),
	(16,'– ¡¿Qué no es justo?!…Llevas una vida de lujo y te atiborras a diario de manjares exquisitos, dignos de un emperador. ¿Es que no tienes suficiente con todo lo que te dan? ¡Haz el favor de dejar el pienso para nosotros! '+char(13)+'
		El cordero puso cara de circunstancias y, con la insolencia de quien lo tiene todo, respondió demostrando muy poca sensibilidad. '+char(13)+'
		– La verdad es que como hasta reventar y este pienso está malísimo comparado con las delicias que me dan, pero lo siento… ¡no soporto que los demás disfruten de algo que yo no poseo! '+char(13)+'
		La oveja se quedó de piedra pómez. '+char(13)+'
		– ¿Me estás diciendo que te comes nuestra humilde comida por envidia?'),
	(16,'El cordero se encogió de hombros y puso cara de indiferencia. '+char(13)+'
		– Si quieres llamarlo envidia, me parece bien. '+char(13)+'
		Ahora sí, la oveja entró en cólera. '+char(13)+'
		– ¡Muy bien, pues tú te lo has buscado! '+char(13)+'
		Sin decir nada más pegó un silbido que resonó en toda la granja. Segundos después, treinta y tres ovejas y nueve carneros acudieron a su llamada. Entre todos rodearon al desconsiderado cordero. '+char(13)+'
	...
	(16,'El malestar empezó a palparse entre la audiencia y la oveja continuó con su alegato. '+char(13)+'
		– En un rebaño no se permiten ni la codicia ni el abuso de poder, así que, en mi opinión, ya no hay sitio para él en esta granja. ¡Que levante la pata quien esté de acuerdo con que se largue de aquí para siempre! '+char(13)+'
		No hizo falta hacer recuento: todos sin excepción alzaron sus pezuñas. Ante un resultado tan aplastante, la jefa del clan determinó su expulsión. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(17,'Érase una vez un mono que más que mono parecía una mula de lo terco que era. ¡Ah! ¿que no te lo crees?… Pues te invito a que descubras hasta qué punto llegaba su cabezonería y verás que no me falta razón. '+char(13)+'
		Resulta que una mañana, el susodicho mono se empeñó en pelar una naranja al tiempo que se rascaba la cabeza porque le picaba muchísimo. Como tenía las dos manos ocupadas en calmar el insoportable cosquilleo, cogió la naranja con la boca y la dejó caer al suelo. Acto seguido se agachó y tiró de la cáscara con sus potentes dientes.  Al primer contacto le supo terriblemente amarga y tuvo que escupir saliva para deshacerse del mal sabor de boca. '+char(13)+'
		– ¡Puaj, qué asco! Esta cáscara es agria y desagradable… Soy incapaz de morderla porque produce escozor en la lengua y… ¡y me entran ganas de vomitar! '+char(13)+'
	...
	(17,'– ¡Je, je, je! ¡Creo que por fin he dado en el clavo! '+char(13)+'
		Sin dejar de rascarse con la izquierda, liberó la derecha y se puso a ello con muchas ganas. El plan no estaba mal, pero a los pocos segundos tuvo que abandonarlo porque la postura era terriblemente incómoda y solo apta para contorsionistas profesionales. '+char(13)+'
		– ¡Ay, así tampoco puedo hacerlo, es imposible! Tendré que probar otra opción si no quiero pasar el resto de mi vida con dolor de riñones. '+char(13)+'
	...
	(17,'– ¡Grrr!… Hoy es mi día de mala suerte, pero no pienso darme por vencido. ¡Voy a comerme esta naranja sí o sí! '+char(13)+'
		¡Ni por esas dejó el mono de rascarse! Emperrado en hacer las dos cosas al mismo tiempo   agarró la naranja con una mano y la introdujo en el río para quitarle la suciedad. Una vez lavada puso sus enormes labios de simio sobre el trozo comestible e intentó succionar el jugo de su interior. De nuevo, las cosas se torcieron: la naranja estaba tan dura que por mucho que apretó con los cinco dedos no pudo exprimirla bien. '+char(13)+'
		– ¡¿Pero qué es esto?!… Solo caen unas gotitas… ¡Estoy hasta las narices!'),
	(17,'A esas alturas estaba tan harto que lanzó la naranja muy lejos y se dejó caer de espaldas sobre la hierba, completamente deprimido.  Mirando al cielo y sin dejar de rascarse, pensó: '+char(13)+'
		– ‘No puede ser que yo,  uno de los animales más desarrollados e inteligentes del planeta, no consiga pelar una simple naranja’. '+char(13)+'
		Cuando ya lo daba todo por perdido, un rayo de luz pasó por su mente. '+char(13)+'
	...
	(17,'Razonar con sensatez le dio buen resultado. Fue corriendo a por la naranja, la cogió con la mano derecha, volvió a remojarla en el río para dejarla reluciente, y con la izquierda retiró los trozos de piel con absoluta facilidad. '+char(13)+'
		– ¡Yupi! ¡Lo he conseguido! ¡Lo he conseguido! '+char(13)+'
		En un periquete tenía todos los gajos a la vista; desprendió el primero  y lo saboreó con placer. '+char(13)+'
	...
	(17,'El mono degustó el apetitoso manjar procurando disfrutar del momento. Cuando terminó se limpió las manos y subió a la rama de su árbol favorito ¿sabes para qué?…  Pues para continuar rascándose a gusto con sus diez grandes dedos de primate. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	...
	(18,'Como es lógico, lo primero que hizo al llegar arriba fue celebrarlo dando botes y gritando de alegría. ¡Se sentía tan orgulloso de sí mismo!… Después hizo un esfuerzo por tranquilizarse, y cuando consiguió bajar las pulsaciones de su corazón y respirar con cierta normalidad, se sentó a disfrutar de la salida del sol. '+char(13)+'
		– Qué aire tan puro se respira aquí… ¡y qué amanecer tan impresionante! '+char(13)+'
		Con el mundo a sus pies se sintió el rey de la montaña. '+char(13)+'
		– Ya que subir me resultó fácil, a partir de ahora vendré a menudo. ¡Las vistas son increíbles! '+char(13)+'
		Tras una buena dosis de belleza y meditación, resolvió que había llegado la hora de regresar a su hogar. '+char(13)+'
		– ¡Bajar va a ser pan comido!… ¡Vamos allá!'),
	(18,'Pegó un salto para levantarse y fue entonces cuando algo terrible sucedió: por un descuido resbaló y empezó a caer montaña abajo dando más botes que una pelota de goma en el patio de un colegio. '+char(13)+'
		– ¡Socorro, que alguien me ayude! '+char(13)+' 
		Rodó y rodó durante un par de minutos que le resultaron interminables, al tiempo que gritaba: '+char(13)+'
		– ¡Ay, ay, me voy a estrellar!… ¡Socorro!… ¡Auxilio! '+char(13)+'
		Cuando estaba a punto de llegar al final y darse el tortazo del siglo, pasó junto a un arbolito cubierto de flores blancas. ¡Era su única oportunidad de salvación! Demostrando buenos reflejos estiró las patas delanteras y se agarró a él desesperadamente. En ese mismo instante, sintió un dolor muy intenso en los dedos. '+char(13)+''),
	(18,'– ¡Ay, ay, ay, ay! ¡¿Pero qué demonios…?! ¡Ay! '+char(13)+'
		¡Qué mala suerte! El arbusto en cuestión era un espino que, como todos los espinos, tenía las ramas cubiertas de afiladísimas púas que se clavaron sin piedad en las patas del zorro. '+char(13)+'
		– ¡Oh, no, esto es horrible, creo que me voy a desmayar!… ¡Maldita planta! '+char(13)+'
		Al escuchar estas palabras, el espino se mostró muy ofendido. '+char(13)+'
		– Perdona que te lo diga, amigo, pero no sé de qué te quejas. Te sujetaste a mí porque te dio la gana. ¡Que yo sepa nadie te obligó! '+char(13)+'
		Con los ojos bañados en lágrimas, el zorro se lamentó:'),
	(18,'– ¡¿Cómo no me voy a quejar?! Solicité tu ayuda porque estaba a punto de matarme ¿y de esta forma me tratas?…  ¡Eres un ser verdaderamente cruel! Mira, me has herido a traición y ahora tengo las patas bañadas en sangre y… ¡llenas de agujeros! '+char(13)+'
		El orgulloso espino, con gesto enfadado, le replicó: '+char(13)+'
		– ¡Por supuesto que te he pinchado!… ¿Sabes por qué? ¡Pues porque soy un espino! Hago daño a todo el que se me acerca y, desde luego, tú no eres una excepción. '+char(13)+'
	...
	(18,'– Creo que estoy siendo muy sincero contigo: yo soy como ves y no voy a cambiar, así que lo mejor que puedes hacer es alejarte de mí para siempre. ¡Ah!, y un consejito te voy a dar: la próxima vez que necesites que alguien te eche una mano, recuerda elegir mejor al amigo que te pueda ayudar. '+char(13)+'
		El zorro se quedó en silencio y se puso a reflexionar sobre las palabras que acababa de escuchar. Finalmente, y a pesar de la frustración, la pena y el dolor que estaba sintiendo, fue capaz de comprender lo que el espino le quería decir. '+char(13)+'
		Y tú… ¿lo has entendido también?'),
	(18,'Moraleja: A lo largo de la vida conocemos a infinidad de personas. La mayoría suelen ser amigables, honestas, sensibles… En definitiva, seres humanos que se esfuerzan por hacer del mundo un lugar mejor. Pero también es cierto que a veces nos topamos con otras que solo piensan en sí mismas, hacen daño sin pensar en las consecuencias, y son incapaces de abrir su corazón para ponerse en el lugar del otro. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	...
	(19,'Sí, el espectáculo era genial ¡pero también muy arriesgado! : un solo fallo y la niña podría caerse sin remedio  desde tres metros sobre el suelo. Al terminar, todos los presentes aplaudían entusiasmados y respiraban tranquilos al ver que pisaba tierra firme, sana y salva. '+char(13)+'
		Casi nadie se iba sin dejar unas monedas en el cestillo. En cuanto se quedaban a solas, contaban las ganancias, compraban comida y, después de una siesta, recogían los petates y tomaban el camino a la siguiente población. '+char(13)+'
	...
	(19,'– He pensado que para evitar un accidente, lo mejor es que cuando hagamos el número, tú estés pendiente de mí y yo de ti ¿Qué te parece? ¡Me da miedo que te caigas del palo y te hagas daño! Si tú vigilas lo que yo hago y yo te vigilo a ti, será mucho mejor. '+char(13)+'
		La niña reflexionó sobre estas palabras y mirándole con ternura, le respondió: '+char(13)+'
		– No, padre, eso no es así. Yo me ocuparé de mí misma y tú de ti mismo, pues la única forma de evitar una catástrofe, es que cada uno esté pendiente de lo suyo. Tú procura hacer bien tu trabajo, que yo haré bien el mío. '+char(13)+'
	...
	(19,'Y así fue cómo, durante muchos años, continuaron alegrando la vida a la gente con sus acrobacias. Como era de esperar, jamás ocurrió ningún percance. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(20,'Había una vez tres ancianos que se conocían desde la infancia y disfrutaban pasando buenos ratos juntos. Tenían en común que eran hombres cultos e inteligentes, pero también que los tres eran ciegos de nacimiento.  Afortunadamente, a pesar de no poder ver, en su día a día se desenvolvían muy bien, pues todavía estaban en buena forma física, sus mentes funcionaban a pleno rendimiento, podían oler, tocar, escuchar, saborear… '+char(13)+'
		Un precioso día de verano se reunieron en su lugar favorito junto al río, se sentaron sobre la hierba, y empezaron a conversar sobre temas científicos. En medio del interesantísimo coloquio se sobresaltaron al escuchar el sonido de varias pisadas. '+char(13)+'
		El anciano que tenía la barba blanca se giró, y algo inquieto preguntó en voz alta: '+char(13)+'
		– ¡¿Quién anda ahí?!'),
	(20,'Por suerte no era ni un espía ni un asaltante de caminos, sino un viajero que llevaba a su lado un enorme elefante con una correa al cuello, como si de un perrillo se tratara. '+char(13)+'
		– Me llamo Kiran, caballeros. Perdonen si les he asustado. Mi elefante y yo venimos a beber  agua fresca y ya nos vamos, que para nada queremos interrumpir su agradable charla. '+char(13)+'
		Los tres pusieron una cara bastante rara, mezcla de sorpresa y emoción. El segundo anciano, que tenía barba negra, quiso asegurarse de lo que Kiran había dicho. '+char(13)+'
		– ¿He oído bien?… Ha dicho usted… ¿elefante?… ¿Un elefante de verdad? '+char(13)+'
		El desconocido reparó en los bastones tirados en la hierba y se fijó en la mirada perdida de los tres viejecitos. Fue cuando se dio cuenta de que eran invidentes. '+char(13)+'
		– Sí señor, voy con mi elefante. Es un animal muy grande, pero no se preocupen, no les hará ningún daño.'),
	(20,'El tercer anciano se atusó la barba pelirroja y le confesó: '+char(13)+'
		– Hemos oído hablar de la existencia de esos animales, pero a este pueblo nunca ha venido ninguno y no sabemos cómo son. ¿Podríamos tocar el suyo para hacernos una idea del aspecto que tienen? '+char(13)+'
		Kiran se mostró encantado. '+char(13)+'
		– ¡Claro, faltaría más! Es un ser muy pacífico y bonachón. ¡Vengan a acariciarlo, no tengan miedo! '+char(13)+'
		Los tres amigos se levantaron, dieron unos pasos  y extendieron la mano derecha. El anciano de barba blanca se topó con una de las patas delanteras y durante un rato la palpó de arriba abajo. '+char(13)+'
	...
	(20,'Mientras, la mano del anciano de barba negra había ido a parar a una de las gigantescas orejas. El animal sintió unas cosquillitas y la sacudió ligeramente hacia delante y hacia atrás. '+char(13)+'
		– ¡Qué dices, querido amigo, un elefante nada tiene que ver con una columna! Mi conclusión es que parece un enorme abanico por dos razones muy obvias: primero, por su forma plana, y segundo, porque al  moverse produce un airecillo de lo más agradable. ¿Es que vosotros no lo notáis? '+char(13)+'
		En ese momento, el anciano de barba pelirroja rozó con la punta de los dedos algo blando que colgaba de algún lugar mucho más alto que él. Era la trompa del cuadrúpedo, pero claro, él no lo sabía. '+char(13)+'
	...
	(20,'El dueño del elefante observaba la escena en silencio y no pudo evitar pensar: '+char(13)+'
		...
		Tras esta reflexión  decidió que antes de que le preguntaran a él, lo mejor era irse cuanto antes. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(21,'Había una vez una niña muy bonita. Su madre le había hecho una capa roja y la muchachita la llevaba tan a menudo que todo el mundo la llamaba Caperucita Roja. '+char(13)+'
		Un día, su madre le pidió que llevase unos pasteles a su abuela que vivía al otro lado del bosque, recomendándole que no se entretuviese por el camino, pues cruzar el bosque era muy peligroso, ya que siempre andaba acechando por allí el lobo. '+char(13)+'
		Caperucita Roja recogió la cesta con los pasteles y se puso en camino. La niña tenía que atravesar el bosque para llegar a casa de la Abuelita, pero no le daba miedo porque allí siempre se encontraba con muchos amigos: los pájaros, las ardillas... '+char(13)+'
		De repente vio al lobo, que era enorme, delante de ella.'),
	(21,'- ¿A dónde vas, niña? - le preguntó el lobo con su voz ronca. '+char(13)+'
		- A casa de mi Abuelita - le dijo Caperucita. '+char(13)+'
		- No está lejos - pensó el lobo para sí, dándose media vuelta. '+char(13)+'
		Caperucita puso su cesta en la hierba y se entretuvo cogiendo flores: - El lobo se ha ido -pensó-, no tengo nada que temer. La abuela se pondrá muy contenta cuando le lleve un hermoso ramo de flores además de los pasteles. '+char(13)+'
		Mientras tanto, el lobo se fue a casa de la Abuelita, llamó suavemente a la puerta y la anciana le abrió pensando que era Caperucita. Un cazador que pasaba por allí había observado la llegada del lobo. '+char(13)+'
	...
	(21,'- Abuelita, abuelita, ¡qué ojos más grandes tienes! '+char(13)+'
		- Son para verte mejor - dijo el lobo tratando de imitar la voz de la abuela. '+char(13)+'
		- Abuelita, abuelita, ¡qué orejas más grandes tienes! '+char(13)+'
		- Son para oírte mejor - siguió diciendo el lobo. '+char(13)+'
		- Abuelita, abuelita, ¡qué dientes más grandes tienes! '+char(13)+'
		- Son para...¡comerte mejoooor! - y diciendo esto, el lobo malvado se abalanzó sobre la niñita y la devoró, lo mismo que había hecho con la abuelita. '+char(13)+'
	...
	(21,'El cazador sacó su cuchillo y rajó el vientre del lobo. La Abuelita y Caperucita estaban allí, ¡vivas!. '+char(13)+'
		Para castigar al lobo malo, el cazador le llenó el vientre de piedras y luego lo volvió a cerrar. Cuando el lobo despertó de su pesado sueño, sintió muchísima sed y se dirigió a un estanque próximo para beber. Como las piedras pesaban mucho, cayó en el estanque de cabeza y se ahogó. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(23,'Barba Alegre era un capitán pirata muy apreciado por toda su tripulación. Todos los piratas que estaban bajo su mando sabían que era justo y trabajador. '+char(13)+'
		Un día, Barba Alegre anunció algo importante a todos los piratas: '+char(13)+'
		-En pocos días llegaremos a Isla Platina, llamada así por todos los tesoros que allí se esconden. '+char(13)+'
		Todos los piratas vitorearon a su capitán. '+char(13)+'
		-Pero solo tenemos una semana para cargar los tesoros en el barco. Lo que no esté cargado en siete días se quedará allí. Todo lo que cojamos será repartido a partes iguales, como siempre. '+char(13)+'
		Los piratas estaban muy contentos. Muchos ya pensaban en retirarse de la vida pirata gracias a ese gran botín.'),
	(23,'Pero cuando llegaron a Isla Platina muchos piratas estaban enfermos. Habían comido algo en mal estado y no tenían fuerzas a para cargar. '+char(13)+'
		-Tranquilos, los demás trabajaremos mientras os recuperáis -dijo el capitán Barba Alegre-. Pero no os preocupéis. Os llevaréis vuestra parte, igual que los demás. '+char(13)+'
		Todos los demás piratas decidieron trabajar más duro para poder sacar más tesoros mientras sus compañeros estaban enfermos. '+char(13)+'
	...
	(23,'-Estos pánfilos están haciendo todo el trabajo mientras nosotros descansamos. Esto sí que es un buen negocio. '+char(13)+'
		En ese momento, el capitán Barba Alegre salió de su escondite y le dijo: '+char(13)+'
		-¡Ah, qué malos compañeros sois! Pues vais a tener vuestro merecido. Solo os llevaréis lo que seáis capaces de sacar por vosotros mismos durante el último día, pues no permitiré que abuséis del trabajo de los demás. Y con eso os dejaré en el primer puerto que encuentre. '+char(13)+'
		Los piratas intentaron hablar. '+char(13)+'
		-Capitán… '+char(13)+'
		-¡Silencio! -dijo este-. Dad gracias de que no os deje aquí, a vuestra suerte. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(24,'Huno odiaba los libros y el mundo. Estaba enojado porque alguna vez le obligaron a leer, y buscaba su venganza llena de rabia. Por eso, cuando se enteró de que en una antigua biblioteca se ocultaban los peores libros del mundo, decidió no parar hasta encontrarla. Pensaba hacerse con el peor de todos, para obligar a leerlo a todos sus enemigos, y a todo el mundo. '+char(13)+'
		Viajó por todas partes revisando libros y mapas, visitando antiguas ruinas, siguiendo pistas mágicas y enigmas misteriosos. Escapó de ladrones de tumbas y contrabandistas, encontró pergaminos perdidos, cruzó islas y volcanes hasta que, finalmente, descubrió la antigua y abandonada biblioteca. '+char(13)+'
	...
	(24,'Como a Huno le gustaba todo lo que tuviera que ver con viajes y aventuras, leyó varias páginas seguidas. Para cuando se dio cuenta de que aquel no podía ser el peor libro del mundo, estaba tan metido en la historia que ya no pudo dejar de leerlo.  '+char(13)+'
		Al día siguiente Huno tomó otro libro que atrapó su imaginación aún más que el anterior, tal y como ocurrió también un día después. Y así, cada día, tomaba un libro con la esperanza de encontrar el peor libro del mundo, pero terminaba leyendo un apasionante libro de aventuras hasta bien entrada la noche. Pasó varios años leyendo, disfrutando tanto que llegó a olvidar por qué estaba allí, hasta que encontró, casi escondido, un libro distinto.  '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	...
	(25,'Marko comprendió entonces para qué servían todas aquellas palabras raras. No eran más que falsos hechizos, un simple truco para conseguir un líder sabio. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(26,'Esta historia viene de un país lejano, más allá e la Galaxia Centuria Laudi 489, pasando por el cinturón de Orión, incluso más lejos del mar de asteroides de plata, en la inmensa oscuridad de la garganta del cráter Mobidub74, había una civilización ancestral que habitaba esas tierras desde los orígenes del universo. Su era nombre Modernia.  '+char(13)+'
		Allí había muy buenos artesanos, expertos en la fabricación de magníficas baterías llenas de energía.Todo transcurría sin problemas en Modernia, todos los días los artesanos se levantaban, construían nuevas baterías y todas las noches las colocaban con orgullo en sus tiendas. '+char(13)+'
	...
	(26,'Pensaron y repensaron, finalmente tuvieron una gran idea: ¡construir robots para usar esas baterías! '+char(13)+'
	...
	(26,'Pero, en realidad, los robots sólo estaban allí porque necesitaban las baterías para vivir, les daba igual dónde o cómo conseguirlas…. '+char(13)+'
		Las baterías, almacenadas en los depósitos, estaban disponibles para todos los robots que pudieran recogerlas por sí mismos. Los robots sólo necesitaban una batería para vivir, y si se pasaban de glotones y trataban de conectarse a dos, podían estropearse y fundirse los plomos. Por eso había un gran letrero en la pared del almacén que decía: «¡No te pongas más de una! ¡Podrías hacerte daño!». '+char(13)+'
		Un robot llamado «Notesacias» fue una vez al depósito debido a su incapacidad para conformarse con las baterías que usaba. Había leído esa advertencia muchas veces pero, desde hacía algún tiempo, había empezado a pensar que los artesanos tenían que ser algo tacaños y que, sólo por esta razón, no permitían que los robots llevaran más de una batería. '+char(13)+'
		Ese día había decidido no obedecer más la señal: así que miró a su alrededor y cuando nadie lo vio, cogió dos baterías, las instaló y… ¡PUM! ¡Todos los circuitos se fundieron! '+char(13)+''),
	(26,'Cuando los otros robots encontraron a su compañero en ese estado, inmediatamente comenzaron a rebelarse: «¡Los artesanos lo hicieron a propósito! ¡Le dieron una batería en mal estado! Sólo un robot, llamado «Ernestus», defendió a los habitantes de la ciudad: «Ellos no son los culpables, el culpable fue el robot Notesacias que se colocó dos baterías y ahora tendrá que ir al mecánico a que le arreglen por completo. '+char(13)+'
		Pero aunque Ernestus tenía razón, la gran mayoría de robots estaba enfadada y no era capaz de entrar en razón. Sus discos duros estaban echando chispas. '+char(13)+'
	...
	(26,'Sus cerebros de tostadora no entendían que sin el trabajo de los artesanos, ninguno de los robots habría sobrevivido todo este tiempo. No se daban cuenta de que sus baterías eran hechas por las manos de esos hombres bajitos de barbas blanca y esas mujeres de estrafalarios peinados. '+char(13)+'
		Ernestus, que era sin duda el robot más inteligente y bueno de la galaxia, siempre pensaba ayudar a los demás, sin importar si eran humanos o robots. Así que encontró una solución para evitar que los malos humos de los robots hicieran daño a los artesanos. '+char(13)+' 
		Como era un robot filosófico, encontró las palabras perfectas para convencer a las dos partes. '+char(13)+'
	...
	(26,'Los artesanos entendieron perfectamente el plan de Ernestus, se montaron en sus motos espaciales… '+char(13)+'
		Y se fueron… '+char(13)+'
		Al ver desaparecer en el infinito horizonte del Universo a los artesanos, los robots estallaron de júbilo. Pensaron que tenían razón, ya que ellos habían ganado la discusión, y que por pegar gritos y hacerse las víctimas de los artesanos, estos habían sido vencidos y ahora todo Modernia era suyo, repleto de jugosas baterías, sin reglas estúpidas de cuántas se podían un robot conectar. '+char(13)+'
		Todo parecía salir victorioso para los robots, mientras tanto, Ernestus aguardaba en lo alto de la torre de luz, sobre el almacén de baterías. '+char(13)+'
		Allí pudo ver cómo poco a poco las despensas se iban agotando, y el almacén cada vez estaba más vacío.'),
	(26,'Pasaron los años, en los que Ernestus se dedicó a reparar a los robots que quedaban dañados por tratar de conectarse varias baterías. Mientras tanto, el resto de la población robótica seguía disfrutando de su triunfo sobro los artesanos, creían que todo este tiempo sin necesitarles, afianzaba más todavía, que ellos tenían razón. '+char(13)+'
		Además, pensaban que el incidente que sufrió Notesacias era evidentemente causado por los artesanos, porque… '+char(13)+'
		¿Cómo era posible que ningún otro robot hubiera sufrido otro percance similar? '+char(13)+'
	...
	(26,'Como Ernestus era muy sabio y paciente, les convencía para que se quedaran en la torre con ellos, que no volvieran a salir de ella y que esperaran pacientemente junto a él. '+char(13)+'
		Así fueron pasando los días, los meses, los años. Llegó un momento en que casi había la misma cantidad de robots en Modernia que en la torre de Ernestus. '+char(13)+'
		Y por fín, la última batería se agotó… El almacén había quedado vacío. '+char(13)+'
		Fue entonces cuando cundió el pánico entre los habitantes robóticos de Modernia, que comenzaron a gritar y a corres despavoridos por todo el país «¿Qué hacemos ahora?» «No quedan baterías» '+char(13)+'
		Con ello, lo que consiguieron fue agotar la energía que les quedaba y uno a uno se fueron apagando todos los robots de Modernia, para siempre…'+char(13)+'
		¿Todos?'),
	(26,'No, Ernestus y sus aliados, aguardaban este día escondidos en su torre de luz. '+char(13)+'
		Uno a uno, fueron conectándose a los enchufes de la torre, para así poder cargar la batería central del foco. Pasadas unas horas, el rayo láser atravesaba la galaxia en busca de los Artesanos nómadas que habían estado vagando con sus motos por todo el Universo desde entonces. '+char(13)+'
		Cuando vieron a lo lejos el destello de luz, no tuvieron que mediar palabra entre ellos. Todos comprendieron que el plan de Ernestus había funcionado a la perfección y volvieron corriendo a Modernia. '+char(13)+'
		Al llegar, el panorama era desolador, cientos y cientos de robots sin batería, tirados por la calle.'),
	(26,'Poco a poco, los robots que se habían quedado con Ernestus, los artesanos y el propio Ernestus, recargaron las baterías de todos los habitantes de Modernia… Que entonces comprendieron lo que Ernestus les quería decir hacía tiempo atrás. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(27,'Durante el año 2152 se encontraban las personas festejando el fin de año con mucha alegría porque comenzaría un nuevo año lleno de sorpresas, pero el mundo ya les tenía una de antemano y antes de que terminaran los festejos se encendieron todas las televisiones al mismo tiempo para enterarse de la última noticia que verían en la tierra. '+char(13)+'
		Todos los asteroides que se encuentran alrededor de Marte y Saturno se habían desviado de su recorrido y vendría directamente hacia estrellarse con la tierra. '+char(13)+'
	...
	(27,'Las personas que en ese entonces se encontraban con vida no murieron tras la explosión porque directamente lo que sucedió fue que quedaron con vida en otro sistema solar, su nombre era Galaxy y tenía 4 planetas que lo conformaban, pero el que cayeron contaba de poco alimento y agua ya que le pertenecía a una raza de extraterrestres. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(28,'Había una vez una Tierra. Y al mismo tiempo, un planeta llamado Marte. Estaban muy lejos el uno del otro, en medio del cielo, y a su alrededor había millones de planetas y galaxias. '+char(13)+'
		La gente de la Tierra quería ir a Marte y a los otros planetas: ¡pero estaban tan lejos! '+char(13)+'
		Sin embargo, no cesaron en su empeño. Primero lanzaron satélites que dieron la vuelta a la Tierra durante dos años y luego volvieron. Luego lanzaron cohetes que dieron la vuelta a la Tierra unas cuantas veces, pero en lugar de regresar, terminaron escapando de la atracción de la gravedad y se dirigieron al espacio. Después de varios años merodeando por el espacio, volvían a la Tierra… Pero había un problema. '+char(13)+'
		Al mando de estos cohetes iban perros '+char(13)+''),
	(28,'Pero los perros no podían hablar, y en la radio de la estación espacial solo se podía oír «guau guau» así que nadie entendía lo que habían visto y lo lejos que habían llegado. '+char(13)+'
		Por fin encontraron hombres valientes que querían ser cosmonautas. Los cosmonautas tenían este nombre porque iban a explorar el cosmos, que es el espacio infinito con los planetas, las galaxias y todo lo que les rodea. '+char(13)+'
		Los cosmonautas se fueron y no sabían si volverían o no. Querían conquistar las estrellas para que un día todos pudieran viajar de un planeta a otro, porque la Tierra se había vuelto demasiado estrecha y la población mundial crecían cada día. '+char(13)+'
		En una hermosa mañana, tres cohetes de tres puntos diferentes dejaron la Tierra.'),
	(28,'El primero fue un americano, que silbó alegremente una pegadiza canción country mientras se alejaba. '+char(13)+'
		En el segundo había un ruso que cantaba con voz grave una comparsa tradicional. '+char(13)+'
		En el tercero, un chino, que cantó una hermosa canción ancestral. '+char(13)+'
		Cada uno quería ser el primero en llegar a Marte, para demostrar que era el más valiente. '+char(13)+'
	...
	(28,'Los cosmonautas miraban el paisaje, se miraban unos a otros, y se mantenían separados, cada uno desconfiando de los demás. Entonces llegó la noche. '+char(13)+'
		Había un extraño silencio alrededor, y la tierra brillaba en el cielo como si fuera una estrella lejana. Los cosmonautas se sintieron tristes y perdidos en la oscuridad. '+char(13)+'
		Pero inmediatamente entendieron que estaban sintiendo lo mismo. Sonreían por primera vez desde que habían pisado el extraño planeta. '+char(13)+'
		Al rato encendían juntos un hermoso fuego y cada uno cantaba canciones de su país. '+char(13)+'
		Finalmente, llegó la mañana '+char(13)+'
		Y hacía mucho frío…'),
	(28,'De repente, un marciano salió de entre un grupo de árboles. ¡Su aspecto era terrible! Era de un color verde viscoso, hacía daño a los ojos de lo que brillaba, tenía dos antenas en el lugar de las orejas, un tronco y seis brazos. Los miró y dijo: ¡Grrr! '+char(13)+'
		En su lengua quería decir: '+char(13)+'
		«Hola seres extraños ¿os habéis perdido?» '+char(13)+'
		Pero los terrícolas no le entendieron y pensaron que era un rugido de guerra. Era tan diferente de ellos que no podían entenderlo. Los tres sintieron inmediatamente miedo por si les atacaba… '+char(13)+'
	...
	(28,'Cuando los tres cosmonautas se habían armado de valor y estaban apuntando al monstruoso alien… Algo extraño sucedió. '+char(13)+'
	...
	(28,'Para cuando se dieron cuenta, el alienígena estaba emitiendo unos extraños ruidos gruturales, que con tan solo observar detenidamente, los tres cosmonautas entendieron que se trataba de un llanto. '+char(13)+'
		Y los terrícolas de repente se dieron cuenta de que el marciano lloraba a su manera, igual que los humanos. '+char(13)+'
		Luego lo vieron inclinarse hacia el pájaro y sostenerlo en sus seis brazos, tratando de calentarlo. '+char(13)+'
		Y así los cosmonautas entendieron una valiosa lección: '+char(13)+'
		«Pensamos que este monstruo era diferente de nosotros, y después de todo también ama, sufre o ríe» '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(29,'Calisto era un inventor al que le encantaban los perros. Pero no podría adoptar ninguno porque le daban alergia. '+char(13)+'
		Como no se resignaba a vivir sin mascota decidió inventar un robot perro. Y así nació Perrobot. '+char(13)+'
		Tras años haciendo pruebas, cálculos y experimentos, Calisto consiguió crear el robot perro perfecto. '+char(13)+'
		Perrobot recibía a Calisto con alegres ladridos cuando llegaba a casa, le provocaba para jugar, se acurrucaba con él y paseaba con él como cualquier otro perro. ¡Incluso le pedía comía, aunque luego no se comiera! '+char(13)+'
	...
	(29,'Pero había algo que fallaba. Calisto era demasiado duro. No estaba suave y blandito como los perros de verdad. Y estaba más bien frío. '+char(13)+'
		Calisto intentó solucionar esto poniéndole una especie de abrigo peludo. Pero Perrobot no funcionaba bien con el abrigo. Fallaba. Y aunque hubiera funcionado, no hubiera servido de mucho. Porque, aunque parecía que le agradaban las caricias, Calisto sabía que, en el fondo, Perrobot era una máquina. '+char(13)+'
		-No sé qué hacer contigo, Perrobot -le dijo un día Calisto-. Eres un gran compañero, pero cuanto más estoy contigo más cuenta de doy de que lo que quiero es un perro de verdad. '+char(13)+'
	...
	(29,'Después de un rato acabaron en la comisaría de policía. '+char(13)+'
		-¿Esto quieres? ¿Quedarte con la policía? '+char(13)+'
		Perrobot ladró. '+char(13)+'
		-¡Pues serías un perrobot policía espectacular! -dijo Calisto-. Vamos a ver qué dice el comisario. '+char(13)+'
		Perrobot se convirtió en perro policía, robot policía, según se mire. Y tuvo tanto éxito que Calisto recibió un montón de encargos. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(30,'Unos chicos se reunieron para trabajar de a 4 en una tarea escolar, podían decidir de qué harían la tarea. Uno de ellos quiso que fuera un cuento, pero otro quiso que fuera de matemáticas, como había que pensar mucho para eso, el siguiente quiso lo mismo que el primero y el último prefirió viajar a la luna. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(31,'Érase una vez a la orilla de un gran río en el Norte de Alemania una ciudad llamada Hamelin. Sus ciudadanos eran gente honesta que vivía felízmente en sus casas de piedra gris. Los años pasaron, y la ciudad se hizo rica y próspera. '+char(13)+'
		Hasta que un día, sucedió algo insólito que perturbó su paz. '+char(13)+'
		Hamelin siempre había tenido ratas, y bastantes, pero nunca habían sido un peligro, pues los gatos las mantenían a rayo de la manera habitual: cazándolas. Pero de pronto, las ratas comenzaron a multiplicarse. '+char(13)+'
	...
	(31,'- Necesitaríamos un ejército de gatos. '+char(13)+'
		Pero los gatos ya estaban muertos. '+char(13)+'
		- Deberíamos matarlas con comida envenenada. '+char(13)+'
		Pero apenas les quedaba comida, y el ni siquiera el veneno era capaz de detenerlas. '+char(13)+'
		- Necesitamos ayuda- dijo el alcalde abatido. '+char(13)+'
	...
	(31,'- He librado ciudades de escarabajos y murciélagos - dijo el extraño- y por mil florines, también les libraré de las ratas. '+char(13)+'
		- ¡Mil florines!- exclamó el alcande- ¡Le daríamos cincuenta mil si lo hiciera! '+char(13)+'
		El extraño salió entonces diciendo: '+char(13)+'
		- Ahora es tarde, pero mañana al amanecer no quedará ni una rata en Hamelin '+char(13)+'
	...
	(31,'Al mediodía, no quedaba ni una sola rata en la ciudad. Todos en el consejo estaban encantados, hasta que el flautista acudió a reclamar su pago. '+char(13)+'
		- ¿Cincuenta mil florines?- exclamaron - ¡Jamás! '+char(13)+'
		- ¡Que sean mil al menos! - gritó furioso el flautista. Pero el alcalde respondió: '+char(13)+'
		- Ahora todas las ratas están muertas y no volverán. Así que confórmate con cincuenta florines, sin es que no quieres quedarte sin nada. '+char(13)+'
		Con los ojos encendidos de ira, el flautista señaló con su dedo al alcalde: '+char(13)+'
		- Te arrepentirás amargamente de haber roto tu promesa '+char(13)+'
		Y desapareció.'),
	(31,'Una sombra de miedo envolvió a los consejeros, pero el alcalde se encogió de hombros y dijo emocionado: '+char(13)+'
		- ¡Qué diablos! Acabamos de ahorrarnos cincuenta mil florines. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(32,'Había una vez un molinero pobre que cuando murió sólo pudo dejar a sus hijos por herencia el molino, un asno y un gato. En el reparto el molino fue para el mayor, el asno para el segundo y el gato para el más pequeño. Éste último se lamentó de su suerte en cuanto supo cuál era su parte. '+char(13)+'
		- ¿Y ahora qué haré? Mis hermanos trabajarán juntos y harán fortuna, pero yo sólo tengo un pobre gato. '+char(13)+'
		El gato, que no andaba muy lejos, le contestó: '+char(13)+'
		- No os preocupéis mi señor, estoy seguro de que os seré más valioso de lo que pensáis. '+char(13)+'
		- ¿Ah sí? ¿Cómo?, dijo el amo incrédulo '+char(13)+'
		- Dadme un par de botas y un saco y os lo demostraré. '+char(13)+'
		El amo no acababa de creer del todo en sus palabras, pero como sabía que era un gato astuto le dio lo que pedía.'),
	(32,'El gato fue al monte, llenó el saco de salvado y de trampas y se hizo el muerto junto a él. Inmediatamente cayó un conejo en el saco y el gato puso rumbo hacia el palacio del Rey. '+char(13)+'
		- Buenos días majestad, os traigo en nombre de mi amo el marqués de Carabás - pues éste fue el nombre que primero se le ocurrió - este conejo. '+char(13)+'
		- Muchas gracias gato, dadle las gracias también al señor Marqués de mi parte. '+char(13)+'
		Al día siguiente el gato cazó dos perdices y de nuevo fue a ofrecérselas al Rey, quien le dio una propina en agradecimiento. '+char(13)+'
		Los días fueron pasando y el gato continuó durante meses llevando lo que cazaba al Rey de parte del Marqués de Carabás. '+char(13)+'
		Un día se enteró de que el monarca iba a salir al río junto con su hija la princesa y le dijo a su amo: '+char(13)+'
		- Haced lo que os digo amo. Acudid al río y bañaos en el lugar que os diga. Yo me encargaré del resto.'),
	(32,'El amo le hizo caso y cuando pasó junto al río la carroza del Rey, el gato comenzó a gritar diciendo que el marqués se ahogaba. Al verlo, el Rey ordenó a sus guardias que lo salvaran y el gato aprovechó para contarle al Rey que unos forajidos habían robado la ropa del marqués mientras se bañaba. El Rey, en agradecimiento por los regalos que había recibido de su parte mandó rápidamente que le llevaran su traje más hermoso. Con él puesto, el marqués resultaba especialmente hermoso y la princesa no tardó en darse cuenta de ello. De modo que el Rey lo invitó a subir a su carroza para dar un paseo. '+char(13)+'
		El gato se colocó por delante de ellos y en cuanto vio a un par de campesinos segando corrió hacia ellos. '+char(13)+'
	...
	(32,'Los campesinos hicieron caso y cuando el Rey pasó junto a ellos y les preguntó de quién era aquél prado, contestaron que del Marqués de Carabás. '+char(13)+'
		Siguieron camino adelante y se cruzaron con otro par de campesinos a los que se acercó el gato. '+char(13)+'
		- Buenas gentes que segáis, si no decís al Rey que todos estos trigales pertenecen al señor Marqués de Carabás, os harán picadillo como carne de pastel. '+char(13)+'
		Y en cuanto el Rey preguntó a los segadores, respondieron sin dudar que aquellos campos también eran del marqués. '+char(13)+'
		Continuaron su paseo y se encontraron con un majestuoso castillo. El gato sabía que su dueño era un ogro así que fue a hablar con el. '+char(13)+'
		- He oído que tenéis el don de convertiros en cualquier animal que deseéis. ¿Es eso cierto? '+char(13)+'
		- Pues claro. Veréis cómo me convierto en león '+char(13)+'
		Y el ogro lo hizo. El pobre gato se asustó mucho, pero siguió adelante con su hábil plan.'),
	(32,'- Ya veo que están en lo cierto. Pero seguro que no sóis capaces de convertiros en un animal muy pequeño como un ratón. '+char(13)+'
		- ¿Ah no? ¡Mirad esto! '+char(13)+'
		El ogro cumplió su palabra y se convirtió en un ratón, pero entonces el gato fue más rápido, lo cazó de un zarpazo y se lo comió. '+char(13)+'
		Así, cuando el Rey y el Marqués llegaron hasta el castillo no había ni rastro del ogro y el gato pudo decir que se encontraban en el estupendo castillo del Marqués de Carabás. '+char(13)+'
		El Rey quedó fascinado ante tanto esplendor y acabó pensando que se trataba del candidato perfecto para casarse con su hija. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(33,'Érase una vez un niño que tenía muchísimos juguetes. Los guardaba todos en su habitación y, durante el día, pasaba horas y horas felices jugando con ellos. '+char(13)+'
		Uno de sus juegos preferidos era el de hacer la guerra con sus soldaditos de plomo. Los ponía enfrente unos de otros, y daba comienzo a la batalla. Cuando se los regalaron, se dio cuenta de que a uno de ellos le faltaba una pierna a causa de un defecto de fundición. '+char(13)+'
	...
	(33,'Y así fue como un día el soldadito pudo conocer a una gentil bailarina, también de plomo. Entre los dos se estableció una corriente de simpatía y, poco a poco, casi sin darse cuenta, el soldadito se enamoró de ella. Las noches se sucedían deprisa, una tras otra, y el soldadito enamorado no encontraba nunca el momento oportuno para declararle su amor. Cuando el niño lo dejaba en medio de los otros soldados durante una batalla, anhelaba que la bailarina se diera cuenta de su valor por la noche , cuando ella le decía si había pasado miedo, él le respondía con vehemencia que no. '+char(13)+'
		Pero las miradas insistentes y los suspiros del soldadito no pasaron inadvertidos por el diablejo que estaba encerrado en una caja de sorpresas. Cada vez que, por arte de magia, la caja se abría a medianoche, un dedo amonestante señalaba al pobre soldadito. '+char(13)+'
		Finalmente, una noche, el diablo estalló.'),
	(33,'-¡Eh, tú!, ¡Deja de mirar a la bailarina! '+char(13)+'
		El pobre soldadito se ruborizó, pero la bailarina, muy gentil, lo consoló: '+char(13)+'
		-No le hagas caso, es un envidioso. Yo estoy muy contenta de hablar contigo. '+char(13)+'
		Y lo dijo ruborizándose. '+char(13)+'
		¡Pobres estatuillas de plomo, tan tímidas, que no se atrevían a confesarse su mutuo amor! '+char(13)+'
		Pero un día fueron separados, cuando el niño colocó al soldadito en el alféizar de una ventana. '+char(13)+'
		-¡Quédate aquí y vigila que no entre ningún enemigo, porque aunque seas cojo bien puedes hacer de centinela!- '+char(13)+'
		El niño colocó luego a los demás soldaditos encima de una mesa para jugar.'),
	(33,'Pasaban los días y el soldadito de plomo no era relevado de su puesto de guardia. Una tarde estalló de improviso una tormenta, y un fuerte viento sacudió la ventana, golpeando la figurita de plomo que se precipitó en el vacío. Al caer desde el alféizar con la cabeza hacia abajo, la bayoneta del fusil se clavó en el suelo. El viento y la lluvia persistían. ¡Una borrasca de verdad! El agua, que caía a cántaros, pronto formó amplios charcos y pequeños riachuelos que se escapaban por las alcantarillas. Una nube de muchachos aguardaba a que la lluvia amainara, cobijados en la puerta de una escuela cercana. Cuando la lluvia cesó, se lanzaron corriendo en dirección a sus casas, evitando meter los pies en los charcos más grandes. Dos muchachos se refugiaron de las últimas gotas que se escurrían de los tejados, caminando muy pegados a las paredes de los edificios. '+char(13)+''),
	(33,'Fue así como vieron al soldadito de plomo clavado en tierra, chorreando agua. '+char(13)+'
		-¡Qué lástima que tenga una sola pierna! Si no, me lo hubiera llevado a casa -dijo uno. '+char(13)+'
		-Cojámoslo igualmente, para algo servirá -dijo el otro, y se lo metió en un bolsillo. '+char(13)+'
		Al otro lado de la calle descendía un riachuelo, el cual transportaba una barquita de papel que llegó hasta allí no se sabe cómo. '+char(13)+'
		-¡Pongámoslo encima y parecerá marinero!- dijo el pequeño que lo había recogido. '+char(13)+'
		Así fue como el soldadito de plomo se convirtió en un navegante. El agua vertiginosa del riachuelo era engullida por la alcantarilla que se tragó también a la barquita. En el canal subterráneo el nivel de las aguas turbias era alto. '+char(13)+'
	...
	(33,'La alcantarilla desembocaba en el río, y hasta él llegó la barquita que al final zozobró sin remedio empujada por remolinos turbulentos. '+char(13)+'
		Después del naufragio, el soldadito de plomo creyó que su fin estaba próximo al hundirse en las profundidades del agua. Miles de pensamientos cruzaron entonces por su mente, pero sobre todo, había uno que le angustiaba más que ningún otro: era el de no volver a ver jamás a su bailarina... '+char(13)+'
		De pronto, una boca inmensa se lo tragó para cambiar su destino. El soldadito se encontró en el oscuro estómago de un enorme pez, que se abalanzó vorazmente sobre él atraído por los brillantes colores de su uniforme. '+char(13)+'
	...
	(33,'Poco después acabó agonizando en una cesta de la compra junto con otros peces tan desafortunados como él. Resulta que la cocinera de la casa en la cual había estado el soldadito, se acercó al mercado para comprar pescado. '+char(13)+'
		-Este ejemplar parece apropiado para los invitados de esta noche -dijo la mujer contemplando el pescado expuesto encima de un mostrador. '+char(13)+'
		El pez acabó en la cocina y, cuando la cocinera la abrió para limpiarlo, se encontró sorprendida con el soldadito en sus manos. '+char(13)+' 
		-¡Pero si es uno de los soldaditos de...! -gritó, y fue en busca del niño para contarle dónde y cómo había encontrado a su soldadito de plomo al que le faltaba una pierna. '+char(13)+'
		-¡Sí, es el mío! -exclamó jubiloso el niño al reconocer al soldadito mutilado que había perdido.'),
	(33,'-¡Quién sabe cómo llegó hasta la barriga de este pez! ¡Pobrecito, cuantas aventuras habrá pasado desde que cayó de la ventana!- Y lo colocó en la repisa de la chimenea donde su hermanita había colocado a la bailarina. '+char(13)+'
		Un milagro había reunido de nuevo a los dos enamorados. Felices de estar otra vez juntos, durante la noche se contaban lo que había sucedido desde su separación. '+char(13)+' 
		Pero el destino les reservaba otra malévola sorpresa: un vendaval levantó la cortina de la ventana y, golpeando a la bailarina, la hizo caer en el hogar. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(34,'Había una vez un leñador tan pobre que ya no tenía ilusiones en esta vida. Estaba desanimado porque jamás había tenido suerte. Su vida era trabajo y más trabajo. Nada de lujos, nada de viajes, nada de diversiones… '+char(13)+'
		Un día, paseando por el bosque, comenzó a lamentarse en voz alta, pensando que nadie le escuchaba. '+char(13)+'
		– No sé lo que es una buena comida, ni dormir en sábanas de seda, ni tener un día libre para holgazanear un poco ¡La vida no ha sido buena conmigo! '+char(13)+'
		En ese instante, se le apareció el gran dios Júpiter con un rayo en la mano. El leñador, asustadísimo, se echó hacia atrás y, tapándose los ojos, empezó a gritar: '+char(13)+'
		– ¡No me haga nada, señor! ¡Por favor, no me haga nada!'),
	(34,'Júpiter le tranquilizó.
		– No temas, amigo, no voy a hacerte ningún daño. Vengo a demostrarte que te quejas sin fundamento. Quiero que te des cuenta por ti mismo de las cosas que realmente merecen la pena. '+char(13)+'
		– No comprendo lo que quiere decir, señor… '+char(13)+'
		– ¡Escúchame atentamente! Te daré una oportunidad que deberás aprovechar muy bien. Pide tres deseos, los que tú quieras, y te los concederé. Eso sí, mi consejo es que pienses  bien lo que vas a pedirme, porque sólo son tres y no hay marcha atrás. '+char(13)+'
		En cuanto dijo estas palabras, el dios se esfumó en el aire levantando una nube de polvo. El leñador, entusiasmado, echó a correr hacia su casa para contarle todo a su mujer. '+char(13)+''),
	(34,'Como os podéis imaginar, su esposa se puso como loca de contenta ¡Por fin la suerte había llegado a sus vidas! Empezaron a hablar de futuro, de todas las cosas que querían comprar y de la cantidad de lugares lejanos que podrían visitar. '+char(13)+'
		– ¡Será genial vivir en una casa grande rodeada de un jardín repleto de magnolios! ¿Verdad, querida mía? '+char(13)+'
		– ¡Sí, sí! Y al fin podremos ir a París ¡Dicen que es precioso! '+char(13)+'
		– ¡Pues a mí me gustaría cruzar el océano Atlántico en un gran barco y llegar a las Américas!… '+char(13)+'
		¡No cabían en sí de gozo! Dejaron volar su imaginación y se sintieron muy afortunados. Pasado un rato se calmaron un poco y la mujer puso un poco de orden en todo el asunto. '+char(13)+'
	...
	(34,'– Tienes razón. Voy a servir un poco de vino y lo tomaremos junto a la chimenea mientras charlamos ¿Te apetece? '+char(13)+'
		– ¡Buena idea! '+char(13)+'
		El leñador sirvió dos vasos y se sentaron juntos al calor del fuego. Estaban  felices y algo más tranquilos. Mientras bebían, el hombre exclamó: '+char(13)+'
		– Este vino está bastante bueno ¡Si tuviéramos una salchicha para acompañarlo sería perfecto! '+char(13)+'
		El pobre leñador no se dio cuenta de que con estas palabras acababa de formular su primer deseo, hasta que una enorme salchicha apareció ante sus narices. '+char(13)+'
		Su esposa dio un grito y, muy enfadada, comenzó a recriminarle. '+char(13)+'
	...
	(34,'– Tienes razón… Ha sido sin querer. Tendré más cuidado la próxima vez. '+char(13)+'
		Pero la mujer había perdido los nervios y seguía riñéndole sin parar. '+char(13)+'
		– ¡Eso te pasa por no pensar las cosas! ¡Deberías ser más sensato! ¡Mira que pedir una salchicha!… '+char(13)+'
		El hombre, harto de recibir reprimendas, acabó poniéndose nervioso él también y contestó con rabia a su mujer: '+char(13)+'
		– ¡Vale, vale, cállate ya! ¡Deja de hablar de la maldita salchicha! ¡Ojalá la tuvieras pegada a la nariz! '+char(13)+'
	...
	(34,'¡La pobre leñadora casi se desmaya del susto! Sin comerlo ni beberlo, ahora tenía una salchicha gigante en la cara. Se miró al espejo y vio con espanto su nuevo aspecto. Intentó quitársela a tirones pero fue imposible: esa salchicha se había pegado a ella de por vida. '+char(13)+'
		Con lágrimas en los ojos e intentando controlar la ira, se giró hacia su marido con los brazos en jarras. '+char(13)+'
		– ¿Y ahora qué hacemos? Sólo podemos formular un último deseo y las cosas se han torcido bastante, como puedes comprobar. '+char(13)+'
	...
	(34,'La mujer no quería ser portadora de una salchicha que afeara eternamente su bello rostro, y el leñador, que la amaba, no quería verla con ese aspecto monstruoso. Al final se pusieron de acuerdo y el hombre, levantándose, exclamó: '+char(13)+'
		– ¡Que la salchicha desaparezca de la nariz de mi mujer! '+char(13)+'
		Un segundo después, la  descomunal salchicha se había volatilizado. La muchacha recobró su belleza y él se sintió feliz de que volviera a ser la misma de siempre. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(35,'Pulgarcito era un niño del tamaño de un pulgar. Era el menor de los 7 hijos de unos leñadores tan pobres que decidieron abandonar a sus hijos en el bosque. Pulgarcito los escuchó, y se preparó para ir dejando caer piedras por el camino y guiar a sus hermanos de vuelta. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(36,'Hace muchísimos años, en la selva amazónica, vivía un pequeño pájaro carpintero que iba a ser papá.  Los días habían pasado rápido y sus crías estaban a punto de nacer. Necesitaba fabricar un nido en un lugar seguro, lejos de los depredadores; por este motivo, eligió la parte alta de un tronco centenario, lejos de miradas indiscretas. '+char(13)+'
	...
	(36,'El sonido de su pico golpeando la madera se extendió por los alrededores y llamó la atención de un tucán. Al principio, el ave de colores no encontraba de dónde salía ese repiqueteo, pero indagó un poco y descubrió al pájaro carpintero trabajando, oculto por el follaje de los árboles. '+char(13)+'
		– ¡Hola, amigo! Veo que estás haciendo un nido para tu familia. '+char(13)+'
		– Sí, así es. Tengo que terminarlo cuanto antes porque mis pequeñuelos llegarán al mundo de un momento a otro. '+char(13)+'
		El tucán estaba fascinado. Nunca había visto a nadie trabajar con tanto interés y decidió hacerle una proposición.'),
	(36,'– ¿Sabes? Yo no tengo casa y me veo obligado a anidar a la intemperie y en cualquier lugar. Nunca me siento seguro y paso bastante frío. Me preguntaba si podría contar contigo para que fabriques un nido para mí. '+char(13)+'
		El pájaro carpintero dejó por un momento de picar la madera y le miró muy interesado. Sus ojos se posaron en el pecho del tucán, un ave realmente hermosa y colorida. '+char(13)+'
		– ¡Se me ocurre una idea! Si te parece bien, yo me comprometo a fabricar tu nido y a cambio, tú me regalas algunas de tus preciosas plumas rojas ¡Creo que serían el adorno perfecto para mi cabeza! '+char(13)+'
		– ¡Fantástico! Es un trato justo para los dos ¡Cuenta con ello!'),
	(36,'En cuanto el pájaro carpintero terminó de construir su nido, se puso a taladrar otro agujero en un árbol vecino para el tucán. Al finalizar la obra, el tucán le felicitó por su buen hacer, se quitó unas cuántas plumas, y se las colocó a su nuevo amigo en la cabeza. Después, los dos volaron hasta una charca que habían formado las lluvias de la mañana. El pájaro carpintero se inclinó un poco para verse y se encontró guapísimo. '+char(13)+'
		– ¡Oh, qué bien me quedan! Muchas gracias, amigo ¡Son preciosas! '+char(13)+'
		– Gracias a ti por construir mi nuevo hogar. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	...
	(37,'Según se contaba por toda la región no había hombre más sabio que él. Conocía todas las hierbas medicinales y los remedios para cada enfermedad por rara que fuera ¡Quizá pudiera curar a su hijo! '+char(13)+'
		– ¡Querido, tenemos que intentarlo! Quédate con el niño mientras yo voy a pedir ayuda al anciano del bosque ¡Solo él puede salvar a nuestro chiquitín! '+char(13)+'
	...
	(37,'– ¿Qué buscas por aquí, mujer? '+char(13)+'
		– ¡Perdone que le moleste pero necesito su ayuda! '+char(13)+'
		– No te preocupes; percibo angustia en tus ojos y en tu voz… ¡Pasa y cuéntemelo todo! '+char(13)+'
		La mujer entró y se acomodó en un sencillo banco construido con un tronco. Con el corazón encogido y los ojos hinchados de tanto llorar, explicó al anciano el motivo de su visita. '+char(13)+'
	...
	(37,'– Lo siento,  lo siento muchísimo…. Voy a ser muy sincero contigo: no conozco el remedio para la enfermedad de tu hijo, pero puedo decirte cuántos días va a vivir. '+char(13)+'
		– ¿Cómo dice? ¡¿Y sin son pocos?! …¡No sé si quiero saberlo! '+char(13)+'
		– No pierdas la esperanza…  ¡Nunca se sabe! '+char(13)+'
		El anciano la miró con ternura y continuó hablando: '+char(13)+'
	...
	(37,'La madre, rota de dolor, echó a correr en busca de la planta que el anciano le había indicado. No tardó mucho en encontrar un arbusto cubierto de preciosas flores amarillas. Se acercó, arrancó una flor y contó sus pétalos. '+char(13)+'
		– ¡Oh, no, no puede ser! Sólo tiene cuatro pétalos… ¡Eso significa que solo va a vivir cuatro días más! '+char(13)+'
	...
	(37,'Cuando terminó, regresó a la cabaña del anciano y le mostró la flor. El hombre, con mucha paciencia, se puso a contar los pétalos, pero eran infinitos y le resultó imposible. '+char(13)+'
		Se atusó su larga barba blanca, suspiró y miró a la mujer con una sonrisa. '+char(13)+'
		– Tengo buenas noticias para ti. Esta flor tiene miles y miles de pétalos, y eso significa que tu hijito vivirá muchísimos años. Seguro que se casará y tendrá y muchos hijos y muchos nietos, ya lo verás.  Ahora, regresa junto a él y confía en su recuperación. '+char(13)+'
		– ¡Mil gracias, señor! Jamás olvidaré lo que ha hecho por mí y por mi familia.'),
	(37,'La mujer, desbordante de felicidad, volvió a casa y entró en el cuarto de su hijo. El chiquitín ya no estaba inmóvil en la cama, sino sentado sobre unos almohadones,  sonriente  y comiendo un plato de sopa ¡Se estaba recuperando! '+char(13)+'
		Pocos días después, el color sonrosado de sus mejillas indicó que había sanado por completo. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(38,'Una antigua leyenda de Noruega nos cuenta por qué el agua del océano es salada ¿Queréis conocer la historia?… '+char(13)+'
		Parece ser que hace muchísimos años, vivía en el norte de Europa un hombre que se dedicaba a recorrer el mundo en su viejo barco. Era un capitán valiente y acostumbrado a vencer las más temibles tempestades, pero por lo visto, también muy ambicioso: le encantaba amasar dinero y ganar cuanto más mejor. '+char(13)+'
	...
	(38,'En una ocasión, llegó a un importante puerto de Noruega donde multitud de comerciantes vendían el pescado fresco recién capturado.  Al capitán le dio buena espina ver tanto bullicio  y se acercó a la lonja deseando hacer un negocio redondo. '+char(13)+'
	...
	(38,'Anochecía cuando soltó amarras y, junto a su tripulación, viró el barco rumbo al sur. Las estrellas le servían de guía y el mar estaba en calma como una balsa de aceite. Parecía una noche perfecta,  pero súbitamente, aparecieron unos enormes nubarrones y estalló una terrible tormenta. La lluvia empezó a inundar el barco y la fuerza de las olas casi les impide mantener el barco a flote. '+char(13)+'
		Por suerte, consiguieron navegar hasta una pequeña isla con la intención de guarecerse hasta que la tormenta amainara. Nunca imaginaron lo que iban a encontrarse allí. '+char(13)+'
	...
	(38,'Se fijaron bien  y descubrieron de qué se trataba: ¡Era un artilugio que trituraba piedras sin que hiciera falta tocarlo! Lo único que hacía el mago para que se pusiera en funcionamiento era decir: '+char(13)+'
		– ¡Muele que te muele! ¡Muele que te muele! ¡Muele que te muele! '+char(13)+'
		¡Los hombres no podían creer lo que estaban viendo! Habían contemplado muchas cosas insólitas en sus viajes por el mundo, pero nunca un artefacto mágico que trabajaba cuando una voz se lo ordenaba. '+char(13)+'
		El capitán, por supuesto, se empeñó en que ese molino tenía que ser suyo. Puso un dedo sobre sus labios para indicar a los hombres que se mantuvieran en silencio y les pidió que no movieran ni un músculo del cuerpo para no ser descubiertos. '+char(13)+'
	...
	(38,'¡Había llegado el momento!  El capitán y los marineros se abalanzaron sobre el molino para robarlo y lo transportaron sigilosamente hasta el barco.  El sol volvía a lucir en lo alto y  pudieron salir zumbando de aquella ínsula. '+char(13)+'
		Nada más alejarse de la costa, el capitán se puso manos a la obra ¡Tenía muy claro cómo sacarle provecho al molinillo! Se dio cuenta de que podía moler los gigantescos bloques de sal que había comprado en el puerto de Noruega y venderla en sacos pequeños. Definitivamente, se haría muy rico. '+char(13)+'
		Colocaron la máquina en la bodega  y metieron dentro los bloques de sal. Terminada la complicada operación, el capitán mandó salir a todo el mundo para quedarse a solas y comenzó a gritar: '+char(13)+'
		– ¡Muele que te muele! ¡Muele que te muele! ¡Muele que te muele! '+char(13)+'
	...
	(38,'Todo iba sobre ruedas, pero el capitán no tuvo en cuenta la potencia de la máquina y en cuestión de minutos la sal comenzó a esparcirse, salió por la puerta e invadió la cubierta de la nave. Asustadísimo, quiso parar el molino, pero no pudo y se encontró con una situación descontrolada. '+char(13)+'
		La sal se desparramaba por todas partes y estaba a punto de llegar a la cima del mástil que sostenía la bandera. Por si esto fuera poco, debido al peso, el barco comenzó a hundirse.  A los desesperados marineros y al capitán no les quedó más remedio que saltar al agua para intentar salvar sus vidas. '+char(13)+'
		Por suerte, consiguieron llegar a nado hasta la costa más cercana. Desde allí, agotados por el esfuerzo, contemplaron con tristeza cómo el barco desaparecía para siempre bajo el profundo y oscuro océano. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(39,'Un frío día de invierno un gran oso polar deambulaba de aquí para allá buscando comida cuando de repente pasó por delante de él una zorra que llevaba varios peces en una bolsa. '+char(13)+'
		El oso estaba muerto de hambre y sintió que la boca se le hacía agua al ver el suculento manjar que la zorra se iba a zampar. Levantó la voz y le preguntó: '+char(13)+'
		– ¡Hola, amiga! Veo que has tenido suerte y hoy vas a cenar como una reina… ¿Dónde has conseguido ese estupendo botín? '+char(13)+'
		La zorra se paró en seco y con cara de despreocupación le dijo: '+char(13)+' 
		– Sencillo, amigo, simplemente fui a pescar. '+char(13)+'
		– ¿A pescar? ¡Pero si el lago está helado! '+char(13)+'
		La zorra, que era muy sabionda, se lo explicó de forma sencilla para que lo entendiera.'),
	(39,'– ¡Amigo, no te enteras! El lago está helado en la superficie pero no en el fondo. Haz un agujero en el hielo con tus garras y después prueba a meter la cola en el agua. En cuanto los peces la vean se acercarán y se agarrarán a ella para mordisquearla.  Cuando notes que han picado unos cuantos, da un tirón fuerte y ya está ¡Comida fresca y abundante para ti! '+char(13)+'
		– ¡Uy, pues sí que parece muy fácil!… '+char(13)+'
		– Lo es, pero te advierto que el agua está muy fría. Tienes que aguantar lo más que puedas porque cuantos más peces se peguen a tu cola mejor será la recompensa, pero tampoco te pases porque las consecuencias pueden ser nefastas. Yo diría que máximo cinco minutos. '+char(13)+'
		– ¡Entendido!  Muchas gracias por tu ayuda y tus buenos consejos. '+char(13)+'
		– ¡De nada, amigo, que tengas mucha suerte!'),
	(39,'La zorra continuó su camino y el gran oso blanco apretó el paso para llegar cuanto antes al lago. Como ya sabía se encontró con que no había agua sino una enorme plancha blanca que sólo servía para patinar o como mucho, para jugar un rato a tirar piedras y verlas rebotar. Animado por la sugerencia  de la zorra, hizo un agujero con las patas, sentó sobre él su enorme trasero, y dejó caer su larga cola dentro del agua. '+char(13)+'
		– ¡Brrrr, brrrr! ¡Qué fría está! '+char(13)+'
	...
	(39,'– Parece que el plan funciona pero tengo mucha hambre  y necesito pescar al menos tres docenas. Aguantaré un ratito más a ver… '+char(13)+'
		Dejó pasar no cinco sino diez minutos y el pobre ya no soportaba más la gélida temperatura del agua, así que se levantó de golpe y dio un fuerte tirón. Desgraciadamente la cola se había congelado como si fuera una estalactita de hielo y se partió de cuajo casi desde la raíz. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(40,'Hace varios siglos, antes del descubrimiento de América, en México vivían los aztecas. Cuenta la leyenda que se alimentaban de raíces de plantas que iban encontrando y de los animales que conseguían cazar cada día. '+char(13)+'
		Su mayor deseo era comer maíz, pero no podían porque crecía escondido detrás de unas altas y escarpadas montañas, imposibles de atravesar. '+char(13)+'
		Un día, pidieron ayuda a varios dioses y éstos, deseando prestar ayuda a los humanos, probaron a separar las gigantescas montañas para que pudieran pasar y llegar hasta el maíz. No sirvió de nada, pues ni los dioses, utilizando toda la fuerza que tenían, lograron moverlas. '+char(13)+'
	...
	(40,'Se acercaron a la que parecía más apetitosa y de ella, extrajeron uno de sus granos amarillos. Entre las dos, iniciaron el camino de regreso con el granito de maíz bien sujeto entre  sus pequeñas mandíbulas. Si antes el camino había sido fatigoso, la vuelta lo era mucho más. La carga les pesaba muchísimo y sus patitas se doblaban a cada paso, pero por nada del mundo podían perder ese granito del color del sol. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(41,'El pez de Lorena se llamaba Darwin. En realidad, el nombre se lo había puesto su hermana mayor, que estudiaba Biología. Lorena nunca se había parado a pesar en la razón. Hasta que un día decidió investigar y descubrió lo siguiente. '+char(13)+'
	...
	(41,'Pensaba que, en su lucha por la supervivencia, algunos organismos se adaptaban mejor que otros a su entorno y así las especies evolucionaban. Su obra más famosa es El origen de las especies. Darwin hablaba de la supervivencia del más apto. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(42,'Aunque sabía que siempre había que tener mucho cuidado, a Lolo le encantaba todo lo relacionado con el fuego. Las cerillas, los mecheros, la chimenea de su casa del pueblo… Un día, intrigado, se dispuso a leer sobre cómo se descubrió el fuego, el primer gran invento de la Humanidad. '+char(13)+'
	...
	(42,'Estos hombres primitivos sabían utilizar el fuego, pero no sabían cómo encenderlo. Poco a poco fueron apareciendo técnicas para generarlo y mantenerlo. Para tareas tan importantes como cocinar alimentos o combatir el frío. Hay teorías que dicen que una persona vio el fuego por primera vez por un rayo de tormenta que incendió un montón de hierba seca. '+char(13)+'
		Después se logró generar fuego. El primer método fue frotar un palo con madera seca. Se hizo también raspando rápidamente dos piedras o rozando una cuerda contra una madera. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(43,'En este nuevo cuento vamos a conocer un poco a uno de los personajes más importantes de la historia de Europa y del mundo: Napoleón Bonaparte. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	...
	(44,'La victoria de los griegos sobre los persas fue muy importante para la evolución de la historia militar griega. De hecho, esta batalla en la llanura de Maratón fue el fin de la invasión persa y permitió a los griegos convertirse en una potencia militar dominante en el Mediterráneo. '+char(13)+'
	...
	(44,'La batalla puso de manifiesto la superioridad griega. De todas formas. estos también se aprovecharon del armamento ligero de los persas y de sus débiles armaduras. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(45,'Midas era un rey que vivía en Frigia, un país en el que nadie pasaba hambre. Los árboles siempre estaban cargados de fruta, el ganado estaba sano y las personas tenían una vida tranquila disfrutando de todo lo que les daba la tierra. '+char(13)+'
		Sin embargo, al contrario que sus súbditos, el rey Midas era muy avaricioso y siempre deseaba más, a pesar de ser ya inmensamente rico. Aunque tuviera el palacio lleno de riquezas y lujos, siempre le parecía poco y soñaba con que su riqueza creciese hasta el infinito. '+char(13)+'
	...
	(45,'Por la mañana, un jardinero le encontró y le condujo ante el rey. Midas, que era un muy buen anfitrión, le acogió en su palacio durante diez días. Cuando pasó ese tiempo y Sileno volvió junto al dios Dionisio, este quiso agradecer a Midas lo bien que había tratado a su amigo. Por eso, fue en busca del rey y le dijo: '+char(13)+'
		-En agradecimiento por haber sido tan hospitalario con mi amigo, te concedo el don que quieras. '+char(13)+'
		Midas llegó a la conclusión de que, aunque fuera muy rico, había un don que siempre había deseado poseer: convertir en oro todo lo que tocase. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(46,'El elefante es un animal muy grande que pertenece a los vertebrados mamíferos. Esto quiere decir que tiene un esqueleto con espina dorsal, además de otros huesos en todo el cuerpo, y además que alimenta a sus crías con la leche que produce la hembra.  '+char(13)+'
		Los elefantes viven en Africa y Asia y se conocen tres especies, los africanos, los asiáticos y los elefantes africanos de la sabana. Aunque son similares en su aspecto, varía su tamaño, el tamaño de sus orejas, o el largo de su trompa. Pero en breve, el elefante asiático es más pequeño que el africano.  '+char(13)+'
	...
	(46,'Aunque a los elefantes se les ve en sus ambientes naturales en junglas, sabanas y desiertos, lo cierto es que prefieren estar cerca al agua. Los elefantes son herbívoros, quiere decir esto que solo comen hojas y plantas. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(47,'La tierra es el planeta donde habitan los humanos y los animales, donde hay agua y plantas. Es uno de muchos planetas en el universo, pero es el único en donde, hasta ahora, se sabe hay vida gracias a que su atmósfera y condiciones climáticas, entre otras características, así lo permite.'+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(48,'Los dientes en tu boca son parte fundamental del proceso digestivo. Gracias a tus dientes puedes masticar todas las comidas por eso debes cuidarlos y prestarles la atención e higiene adecuada. Además, en tu boca está la lengua, el paladar y las encías. '+char(13)+'
		Con la boca puedes hablar, sonreír y hacer gestos que comunican tu estado de ánimo. También puedes respirar a través de la boca.  '+char(13)+'
	...
	(48,'En la lengua, que es un músculo, están las papilas gustativas que te ayudan a percibir el sabor de las comidas. En la boca también están las glándulas salivares, que secretan la saliva que mantiene tu boca mojada y ayuda a mojar la comida que consumes y formar el bolo alimenticio.  '+char(13)+'
		Los dientes están hechos de cuatro tipos de tejido, pulpa, dentina, cemento y esmalte. En la boca de un adulto hay 32 dientes, y en la boca de un niño hay 20. Alrededor de los seis años de edad, un poco después para algunos, los niños y niñas comienzan a perder los dientes de bebé y estos son reemplazados por los dientes de adultos. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(49,' El girasol  es una planta que se renueva    cada año y puede alcanzar un tamaño de entre un 1 y 3 metros. Este pertenece a la familia de las Asteráceas esta la cual está compuesta por entre 20,00 y 30,000 especímenes. '+char(13)+'
		Los girasoles tienen tallos largos y  poseen pelos toscos.  En tanto las cabezuelas están compuestas de diversas flores sésiles amarillas en forma de copa. '+char(13)+'
	...
	(49,'El girasol habita principalmente en Norteamérica pero gracias a la gran adaptabilidad de la planta y a que es utilizada para usos ornamentales y alimenticios, esta ha podido extenderse alrededor del mundo. En la actualidad podemos encontrar girasoles en China, Bolivia, Argentina, España, Francia, México, Perú y Rusia.  '+char(13)+'
		Origen de los girasoles '+char(13)+'
		Los girasoles son originarios del norte de México y el oeste de Estados unidos, en donde eran cultivados por los indígenas hace aproximadamente unos 3000 a.C. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(50,'Los insectos están en todas partes. Piensa por un momento que esta especie compone el 90% de la vida que hay en el planeta. Para que te hagas una idea, sería como decir que por cada persona que hay en el mundo hay más o menos 200 millones de insectos. '+char(13)+'
		Cuando sales al jardín o vas a la playa, estás en la montaña o vas a una jungla, ahí hay insectos. Los especialistas que estudian insectos se llaman entomólogos. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(51,'En un pueblo de América Latina, en una gran casa con jardín, vivía un hombre solitario al que sólo le gustaba la compañía de su viejo criado. '+char(13)+'
		El sirviente llevaba muchos años a su servicio y se encargaba de todos los quehaceres para que el hogar estuviera siempre limpio y ordenado. Cada mañana se levantaba antes del amanecer para hacer las camas, quitar el polvo y tener listo el desayuno a primerísima hora.  No había nadie más profesional, servicial y educado que él, y por eso, el señor de la casa le respetaba y apreciaba mucho. '+char(13)+'
		Un día este hombre, que dirigía una empresa y siempre estaba muy ocupado, llegó a casa muy alterado.'),
	(51,'– ¡Estoy enfadadísimo! Toda la mañana en reuniones de trabajo y no ha servido para nada ¡Estoy rodeado de holgazanes que no tienen dos dedos de frente! '+char(13)+'
		El criado, que tenía confianza con él, intentó quitarle hierro al asunto para que se apaciguara. '+char(13)+'
		– Tranquilo que ya verá cómo el problema no es tan grave y tiene solución. Me disgusta que  regrese de la oficina así de disgustado ¡Se ha puesto tan colorado que parece que va a explotar! '+char(13)+'
		Pero él seguía echando chispas, agitando las manos y gritando como un descosido. '+char(13)+'
		– ¡No puedo, no puedo! ¡Encima llevo seis horas sin comer y estoy hambriento! ¡Sírveme la comida ahora mismo porque si no me voy a desmayar! '+char(13)+'
	...
	(51,'– Aquí tiene una deliciosa sopa de verduras, su favorita. Ande, tómesela, ya verá qué bien le sienta. '+char(13)+'
		El caballero se sentó a la mesa, se ató una servilleta de lunares al cuello y metió la cuchara en la sopa. En cuanto la probó… '+char(13)+'
		– ¡Puaj, qué asco de sopa! ¡Esto es incomible! No tiene ni pizca de sal y encima  ¡está helada! '+char(13)+'
		Fue la gota que colmó el vaso; se levantó y en un arrebato de furia, agarró el plato y lo lanzó por la ventana. '+char(13)+'
		En un primer momento el criado no supo qué pensar ni qué hacer, pero enseguida reaccionó;  En silencio se acercó a la mesa, cogió el pan, el vino, la servilleta, los cubiertos y el mantel, y también los lanzó por la ventana con tantas ganas que atravesaron medio jardín. '+char(13)+'
		Los gritos del señor retumbaron por toda la casa.'),
	(51,'– ¡¿Pero qué haces, inútil?!  ¿Cómo te atreves a tirar mis pertenencias?  ¿Quién te crees que eres? '+char(13)+'
		El criado, sin perder la calma, le miró a los ojos y respondió: '+char(13)+'
	...
	(51,'El amo se sintió muy avergonzado porque sabía que su criado y viejo amigo sólo quería demostrarle lo feo que había sido su comportamiento. '+char(13)+'
		– Lo siento, lo siento mucho…  Por culpa de los nervios me he comportado como un ser irracional, maleducado y lleno de soberbia.  Espero que sepas perdonarme. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(52,'En un recóndito bosque cientos de pajaritos diferentes entonaban cada día sus más lindas melodías. Los había de toda clase y condición. Algunos, por ejemplo,  tenían el trino grave y elegante, mientras que otros cantaban en un tono tan dulce como el de un flautín. También había mucha variedad según el color: pajaritos marrones, pajaritos blanquiazules, pajaritos verdes con el pico moteado… '+char(13)+'
		Entre ellos había uno que era muy popular porque había tenido la suerte de nacer con un plumaje espectacular, con más colores que el mismísimo arco iris. Era el pájaro más bello, pero también el que más envidias despertaba. '+char(13)+'
		Un día, una urraca negra que se moría de celos, le gritó con su característica voz rota y desagradable:'),
	(52,'– ¡Cra cre cri, Pajarito Remendado, cri cro cru! ¡Cra cre cri, Pajarito Remendado, cri cro cru! '+char(13)+'
		El pajarito ni la miró, pero la urraca siguió burlándose de él. '+char(13)+'
		– A partir de ahora te llamaré Pajarito Remendado ¿sabes por qué?…  Pues porque tienes una pluma de cada color y parece que llevas un traje viejo lleno de remiendos ¡Cri cro cru! '+char(13)+'
		Al pajarito no le importó y con el mote de Pajarito Remendado se quedó. '+char(13)+'
	...
	(52,'El pobre Pajarito Remendado sintió cómo suelo se alejaba y se difuminaba cada vez más. Temblaba como un flan y pensaba que era el fin de su vida. '+char(13)+'
		– ¡Oh, no! Me temo que esta noche las crías del águila van a cenar un suculento pajarillo de colores… ¡Y yo soy esa cena! '+char(13)+'
		Mientras tanto abajo en el bosque se montó un tremendo revuelo. Todos los pajaritos, que apreciaban mucho a Pajarito Remendado,  comenzaron a chillar y a llorar cuando vieron que el águila se llevaba a su querido amigo. '+char(13)+'
		– ¡El águila ha raptado a Pajarito Remendado! '+char(13)+'
		– ¡Tenemos que hacer algo! '+char(13)+'
		– ¡Pobre Pajarito Remendado, no se lo merece!'),
	(52,'– ¡Conseguiremos que esa ladrona lo libere! '+char(13)+'
		Pajarito Remendado, que tenía muy buen oído, escuchaba los llantos desesperados de sus amigos mientras notaba la insoportable presión del pico del águila sobre su frágil cuerpecillo. Le quedaba poco tiempo y tenía que encontrar una manera rápida y eficaz de zafarse de la situación ¡Era cuestión de vida o muerte! '+char(13)+'
		Pensó a toda velocidad y se dio cuenta de algo muy importante: la única oportunidad que tenía de salvar su vida era consiguiendo que el águila abriera el pico, así que fue a por todas. '+char(13)+'
		– Señora águila ¿está oyendo lo que dicen esos pájaros ahí abajo? ¡La están insultando! ¡La están llamando ladrona! ¿Acaso no va a contestarles? '+char(13)+''),
	(52,'El águila siguió batiendo las alas haciendo como que no escuchaba los abucheos. '+char(13)+'
		– ¡Devuélvenos a nuestro amigo! '+char(13)+'
		– ¡Esto es vergonzoso! ¡Abusadora! '+char(13)+'
		– ¡Maldita águila, suéltalo de una vez! '+char(13)+'
		Pajarito Remendado se iba quedando sin fuerzas y poco faltaba para llegar al nido donde  esperaban los aguiluchos hambrientos ¡Tenía que seguir intentándolo! '+char(13)+'
		– Señora águila… ¿No los oye? ¡Pero dígales algo! Si yo fuera la reina de las aves no consentiría que me insultaran ¡Por favor, hágase valer! '+char(13)+'
	...
	(52,'Su paciencia se terminó. Harta de insultos y de que la llamaran de todo menos bonita, pegó un grito que hizo temblar a las nubes: '+char(13)+'
		– ¡Idos a freír espárragos y meteos en vuestros asuntos, panda de cotillas! ¡Yo soy el águila real y hago lo que me da la real gana! '+char(13)+'
		¡El águila cayó en la trampa! Para responder la muy insensata abrió el pico y Pajarito Remendado quedó libre. '+char(13)+'
	...
	(52,'Pajarito Remendado había conseguido salvarse gracias a su ingenio y ahora estaba de nuevo con sus compañeros del bosque, riéndose y cantando como siempre. '+char(13)+' 
		A partir de ese día Pajarito Remendado no sólo fue famoso por su plumaje de mil colores  y por su peculiar mote, sino también por su valentía y capacidad para salir de situaciones difíciles. '+char(13)+'')
...
INSERT INTO [Page](IdContent,Text) 
	...
	(53,' Un día, por fin, se disiparon todas sus dudas y mandó llamar a los mensajeros reales. '+char(13)+'
		– Quiero que anunciéis a lo largo y ancho de mis dominios, que todas las mujeres que deseen convertirse en mi esposa tendrán que presentarse dentro de una semana en  palacio, a primera hora de la mañana. '+char(13)+'
		Los mensajeros, obedientes y siempre leales a la corona, recorrieron a caballo todos los pueblos y ciudades del reino. No quedó un solo rincón ajeno a la noticia. '+char(13)+'
	...
	(53,'Impacientes, esperaron a que el príncipe se asomara al balcón e hiciera públicas sus intenciones. Cuando apareció, suspiraron emocionadas e hicieron una pequeña reverencia. En silencio, escucharon sus palabras con atención. '+char(13)+'
		– Os he pedido que vinierais hoy porque he de escoger la mujer que será mi esposa. Os daré a cada una de vosotras una semilla para que la plantéis. Dentro de seis meses, os convocaré aquí otra vez, y la que me traiga la flor más hermosa de todas, será la elegida para casarse conmigo y convertirse en princesa. '+char(13)+'
	...
	(53,'Era una jovencita linda de ojos grandes y largos cabellos, pero sus ropas eran viejas y estaban manchadas de hollín porque siempre andaba entre fogones.  A pesar de que era pobre y se sentía como una mota de polvo entre tanta bella mujer, aceptó la semilla que le ofrecieron y la plantó en una vieja maceta de barro ¡Siempre había estado enamorada del príncipe y casarse con él era su sueño desde niña! '+char(13)+'
		Durante semanas la regó varias veces al día e hizo todo lo posible para que brotara una planta que luego diera una hermosísima flor. Probó a cantarle con dulzura y a resguardarla del frío de la noche, pero no fue posible. Desgraciadamente, su semilla no germinó. '+char(13)+''),
	(53,'Cuando se cumplieron los seis meses de plazo, todas las muchachas acudieron a la cita con el príncipe y formaron una larga fila. Cada una de ellas portaba una maceta en la que crecía una magnífica flor; si una era hermosa, la siguiente todavía era más exuberante. '+char(13)+'
		El príncipe bajó a los jardines y, muy serio, empezó a pasar revista. Ninguna flor parecía interesarle demasiado. De pronto, se paró frente a la hija de la cocinera, la única chica que sostenía una maceta sin flor y donde no había nada más que tierra que apestaba a  humedad. La pobre miraba al suelo avergonzada. '+char(13)+'
		– ¿Qué ha pasado?  ¿Tú no me traes una maravillosa flor como las demás?'),
	(53,'– Señor, no sé qué decirle… Planté mi semilla con mucho amor y la cuidé durante todo este tiempo para que naciera una bonita planta, pero el esfuerzo fue inútil. No conseguí  que germinara. Lo siento mucho. '+char(13)+'
		El príncipe sonrió, acercó la mano a la barbilla de la linda muchacha  y la levantó para que le mirara a los ojos. '+char(13)+'
		– No lo sientas… ¡Tú serás mi esposa! '+char(13)+'
		Las damas presentes se giraron extrañadas y comenzaron a cuchichear: ¿Su esposa?  ¡Pero si es la única que no ha traído ninguna flor! ¡Será una broma!… '+char(13)+'
	...
	(53,'– Durante mucho tiempo estuve meditando sobre cuál  es la cualidad que más me atrae de una mujer  y me di cuenta de que es la sinceridad. Ella ha sido honesta conmigo y la única que no ha tratado de engañarme. '+char(13)+'
		Todas las demás se miraban perplejas  sin entender nada de nada. '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	...
	(54,'Un día, no se sabe por qué razón, el amo decidió poner dos sacos sobre el lomo de asno y ninguno sobre el lomo del caballo. Lo siguiente que hizo fue dar la orden de partir. '+char(13)+'
		– ¡Arre, caballo! ¡Vamos, borrico!… ¡Daos prisa o llegaremos tarde! '+char(13)+'
		Se adelantó unos metros y ellos fueron siguiendo sus pasos, como siempre perfectamente sincronizados.  Mientras caminaban, por primera vez desde que tenía uso de razón, el asno se lamentó: '+char(13)+'
		– ¡Ay, amigo, fíjate en qué estado me encuentro! Nuestro dueño puso todo el peso sobre mi espalda y creo que es injusto. ¡Apenas puedo sostenerme en pie y me cuesta mucho respirar! '+char(13)+''),
	(54,'El pequeño burro tenía toda la razón: soportar esa carga era imposible para él. El caballo, en cambio, avanzaba a su lado ligero como una pluma y sintiendo la perfumada brisa de primavera peinando su crin. Se sentía tan dichoso, le invadía una sensación de libertad tan grande, que ni se paró a pensar en el sufrimiento de su colega. A decir verdad, hasta se sintió molesto por el comentario. '+char(13)+'
		– Sí amiguete, ya sé que hoy no es el mejor día de tu vida, pero… ¡¿qué puedo hacer?!… ¡Yo no tengo la culpa de lo que te pasa! '+char(13)+'
	...
	(54,'– Te ruego que no me malinterpretes, amigo mío. Por nada del mundo quiero fastidiarte, pero la verdad es que me vendría de perlas que me echaras una mano. Me conoces y sabes que no te lo pediría si no fuera absolutamente necesario. '+char(13)+'
		El caballo dio un respingo y puso cara de sorpresa. '+char(13)+'
		– ¡¿Perdona?!… ¡¿Me lo estás diciendo en serio?! '+char(13)+'
		El asno, ya medio mareado, pensó  que estaba en medio de una pesadilla. '+char(13)+'
		– ‘No, esto no puede ser real… ¡Seguro que estoy soñando y pronto despertaré!’ '+char(13)+''),
	(54,'El sudor empezó a caerle a chorros por el pelaje y notó que sus grandes ojos almendrados  empezaban a girar cada uno hacia un lado, completamente descontrolados. Segundos después todo se volvió borroso y se quedó prácticamente sin energía. Tuvo que hacer un esfuerzo descomunal para seguir pidiendo auxilio. '+char(13)+'
		– Necesito que me ayudes porque yo… yo no puedo, amigo, no puedo continuar… Yo me… yo… ¡me voy a desmayar! '+char(13)+'
		El caballo resopló con fastidio. '+char(13)+'
	...
	(54,'Bajo el sol abrasador al pobre asno se le doblaron las patas como si fueran de gelatina. '+char(13)+'
		– ¡Ayuda… ayuda… por favor! '+char(13)+'
		Fueron sus últimas palabras antes de derrumbarse sobre la hierba. '+char(13)+'
		¡Blooom! '+char(13)+'
		El dueño, hasta ese momento ajeno a todo lo que ocurría tras de sí, escuchó el ruido sordo que hizo el animal al caer. Asustado se giró y vio al burro inmóvil, tirado con la panza hacia arriba y la lengua fuera. '+char(13)+'
	...
	(54,'Hecho un manojo de nervios miró a su alrededor y detuvo la mirada sobre el caballo. '+char(13)+'
		– ¡Ahora que lo pienso te tengo a ti! Tú serás quien me ayude en esta difícil situación. ¡Venga, no perdamos tiempo, agáchate! '+char(13)+'
		El desconcertado caballo obedeció y se tumbó en el suelo. Entonces, el hombre colocó sobre su lomo los dos sacos de harina, y seguidamente arrastró al burro para acomodarlo también sobre la montura. Cuando tuvo todo bien atado le dio unas palmaditas cariñosas en el cuello. '+char(13)+' 
		– ¡Ya puedes ponerte en pie! '+char(13)+'
		El animal puso cara de pánico ante lo que se avecinaba.'),
	(54,'– Sí, ya sé que es muchísimo peso para ti, pero si queremos salvar a nuestro amigo solo podemos  hacerlo de esta manera. ¡Prometo que te recompensaré con una buena ración de forraje! '+char(13)+'
		El caballo soltó un relincho que sonó a quejido, pero de nada  sirvió. Le gustara o no, debía  realizar la ruta de regreso a casa con un cargamento descomunal sobre la espalda. '+char(13)+'
	...
	(54,'El caballo, por el contrario, se quedó tan hecho polvo, tan dolorido y tan débil,  que tardó tres semanas en recuperarse. Un tiempo muy duro en el que también lo pasó mal a nivel emocional porque se sentía muy culpable. Tumbado sobre el heno del establo lloriqueaba y repetía sin parar: '+char(13)+'
		– Por mi mal comportamiento casi pierdo al mejor amigo que tengo…  ¿Cómo he podido portarme así con él?… ¡Tenía que haberle ayudado!… ¡Tenía que haberle ayudado desde el principio! '+char(13)+'
...
INSERT INTO [Page](IdContent,Text) 
	VALUES
	(55,'Érase una vez un buen hombre que se ocupaba de las labores del campo. Toda su vida se había dedicado a labrar la tierra para obtener alimentos con los que sostener a su numerosa familia. '+char(13)+'
		Era mayor y tenía varios hijos a los que sacar adelante. Todos eran buenos chicos, pero cada uno tenía un carácter tan distinto que se pasaban el día peleándose entre ellos por las cosas más absurdas. En casa siempre se escuchaban broncas, gritos y portazos. '+char(13)+'
	...
	(55,'De repente, una lucecita iluminó su cerebro ¡Ya lo tenía! '+char(13)+'
		– ¡Venid todos ahora mismo, tengo algo que deciros! '+char(13)+'
		Los hermanos acudieron obedientemente a la llamada de su padre ¿Qué querría a esas horas? '+char(13)+'
		– Os he mandado llamar porque necesito que salgáis fuera y recojáis cada uno un palo delgado, de esos que hay tirados por el campo. '+char(13)+'
		– ¿Un palo? … Papá ¿estás bien? ¿Para qué quieres que traigamos un palo? –dijo uno de ellos tan sorprendido como todos los demás. '+char(13)+'
		– ¡Haced lo que os digo y hacedlo ahora! – ordenó el padre. '+char(13)+'
	...
	(55,'– Ahora, dádmelos – dijo mirándoles a los ojos. '+char(13)+'
		El padre cogió todos los palitos y los juntó con una fina cuerda. Levantó la vista y les propuso una prueba. '+char(13)+'
		– Quiero ver quién de todos vosotros es capaz de romper estos palos juntos. Probad a ver qué sucede. '+char(13)+'
		Uno a uno, los chicos fueron agarrando el haz de palitos y con todas sus fuerzas intentaron partirlos, pero ninguno lo consiguió. Estaban desconcertados. Entonces, el padre desató la cuerda que los unía. '+char(13)+'
		– Ahora, coged cada uno el vuestro y tratad de romperlo. '+char(13)+'
